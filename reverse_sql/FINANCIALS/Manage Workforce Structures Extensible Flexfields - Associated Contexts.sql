 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Workforce%20Structures%20Extensible%20Flexfields%20-%20Associated%20Contexts.sql $:
 * $Id: Manage Workforce Structures Extensible Flexfields - Associated Contexts.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
,'' RES_INHERITED
,DECODE(contextsE0.PROTECTED_FLAG,'Y','Yes','No') RES_PROTECTED
,(SELECT NAME
	FROM FND_EF_CATEGORIES_VL
	WHERE CATEGORY_CODE = contextassociatesE0.CATEGORY_CODE
	) RES_ASSOCIATED_CATEGORY
,(SELECT MEANING
	FROM FND_LOOKUPS
...
,contextassociatesE0.LAST_UPDATED_BY RSC_LAST_UPDATED_BY
,contextassociatesE0.LAST_UPDATE_DATE RSC_LAST_UPDATE_DATE
,contextassociatesE0.CREATED_BY RSC_CREATED_BY
,contextassociatesE0.CREATION_DATE RSC_CREATION_DATE
,NULL RSC_LEDGER_ID
...
,FND_EF_CATEGORY_CONTEXTS contextassociatesE0
,FND_DF_CONTEXTS_VL contextsE0
WHERE QTSLR.APPLICATION_ID = contextassociatesE0.APPLICATION_ID
AND QTSLR.DESCRIPTIVE_FLEXFIELD_CODE = contextassociatesE0.DESCRIPTIVE_FLEXFIELD_CODE
AND QTSLR.CATEGORY_CODE = contextassociatesE0.CATEGORY_CODE
AND contextassociatesE0.DESCRIPTIVE_FLEXFIELD_CODE = contextsE0.DESCRIPTIVE_FLEXFIELD_CODE
AND contextassociatesE0.APPLICATION_ID = contextsE0.APPLICATION_ID
AND contextassociatesE0.CONTEXT_CODE = contextsE0.CONTEXT_CODE