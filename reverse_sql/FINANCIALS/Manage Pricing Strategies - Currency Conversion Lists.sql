...
,(SELECT NAME
	FROM QP_CURR_CONV_LISTS_TL
	WHERE CURRENCY_CONV_LIST_ID = QpStrategyDetailE0.DETAIL_ENTITY_ID
	AND LANGUAGE        = USERENV('LANG')
	) RES_CURRENCY_CONVERSION_LIST_N
...
AND QpStrategyDetailE0.DETAIL_ENTITY_TYPE_CODE = 'CURRENCY_CONVERSION'
