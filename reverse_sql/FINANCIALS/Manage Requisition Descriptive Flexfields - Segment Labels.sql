...
* $Id: Manage Requisition Descriptive Flexfields - Segment Labels.sql 53610 2016-03-17 04:01:59Z nasrullah.dusenmahamad $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
WHERE SegmentLabel.APPLICATION_ID = 10071
AND DescriptiveFlexfieldEO.DESCRIPTIVE_FLEXFIELD_CODE = SegmentLabel.DESCRIPTIVE_FLEXFIELD_CODE
