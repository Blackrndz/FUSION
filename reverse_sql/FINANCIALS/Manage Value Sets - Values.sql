...
* $Date: 2023-03-20 12:39:02 +0700 (Mon, 20 Mar 2023) $:
* $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Value%20Sets%20-%20Values.sql $:
* $Id: Manage Value Sets - Values.sql 80492 2023-03-20 05:39:02Z pisan.jariyasettachok $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
,DECODE(ValueSetPEO.INDEPENDENT_VALUE_SET_ID,NULL,NULL
	,DECODE((SELECT VALUE_DATA_TYPE FROM FND_VS_VALUE_SETS WHERE VALUE_SET_ID = ValueSetPEO.INDEPENDENT_VALUE_SET_ID)
		,'VARCHAR2',ValueSetValuePEO.INDEPENDENT_VALUE
		,'NUMBER',TO_CHAR(ValueSetValuePEO.INDEPENDENT_VALUE_NUMBER)
		,'DATE',TO_CHAR(ValueSetValuePEO.INDEPENDENT_VALUE_DATE,'DD-Mon-YYYY')
		,'TIMESTAMP',TO_CHAR(ValueSetValuePEO.INDEPENDENT_VALUE_TIMESTAMP,'DD-Mon-YYYY HH24:MI:SS'))
	) AS RES_INDEPENDENT_VALUE
