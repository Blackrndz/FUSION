 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Elements%20-%20Standard%20Earnings.sql $:
 * $Id: Manage Elements - Standard Earnings.sql 78239 2022-04-07 15:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
,(CASE
	WHEN elementsE0.PROCESS_MODE != 'N' THEN
		'No' 
	END) RES_TAX_THIS_EARNING_ACROSS_MU -- Tax this earning across multiple pay periods?
,(CASE
...
AND prClassesE0.CLASSIFICATION_NAME = 'Standard Earnings'
...
--AND elementsE0.ELEMENT_NAME NOT LIKE '%Earnings%'
