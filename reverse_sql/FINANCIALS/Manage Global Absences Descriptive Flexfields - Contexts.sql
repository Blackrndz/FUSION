...
* $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Global%20Absences%20Descriptive%20Flexfields%20-%20Contexts.sql $:
* $Id: Manage Global Absences Descriptive Flexfields - Contexts.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
WHERE DescriptiveFlexfieldEO.APPLICATION_ID = 10110
AND DescriptiveFlexfieldEO.DESCRIPTIVE_FLEXFIELD_CODE IN
	...
	AND BoAttributeValuesEO.TASK_ID                   =
		(SELECT task_id
		FROM ASK_TASKS_VL
		WHERE TASK_SHORT_NAME = 'ORA_ANC_MANAGE_GLOBAL_ABSENCE_DESCRIPTIVE_FLEXFIELDS'))
		)
