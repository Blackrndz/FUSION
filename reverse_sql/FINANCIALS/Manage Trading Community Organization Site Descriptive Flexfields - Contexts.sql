...
* $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Trading%20Community%20Organization%20Site%20Descriptive%20Flexfields%20-%20Contexts.sql $:
* $Id: Manage Trading Community Organization Site Descriptive Flexfields - Contexts.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
WHERE DescriptiveFlexfieldContextE1.APPLICATION_ID = 10024
AND DescriptiveFlexfieldContextE1.DESCRIPTIVE_FLEXFIELD_CODE = 'HZ_PARTY_SITES'
