...
* $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Legal%20Entity%20(United%20Kingdom)%20-%20Manage%20Legal%20Entities.sql $:
* $Id: Manage Legal Entity (United Kingdom) - Manage Legal Entities.sql 78399 2022-04-29 08:46:30Z tanawat.wongjan $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
,XleRegistrations.REGISTRATION_NUMBER   AS RES_COMPANY_NUMBER
,(SELECT REGISTRATION_NUMBER
    ...
    and ETB_INFORMATION_CONTEXT =  'GB'
		)
    and JURISDICTION_ID = XleJurisdictionsVl.JURISDICTION_ID
	) AS RES_CUIT
...
AND TerritoryPEO.TERRITORY_CODE         = 'GB'
ORDER BY RES_NAME