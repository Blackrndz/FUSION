...
,DECODE(hxtTCLATDEFNSVEO.TCLAYFLD_ATTRIBUTE_CHAR27,'Y','Yes','No') RES_SHOW_IN_ADDITIONAL_ATTRIBU
,DECODE(hxtTCLATDEFNSVEO.TCLAYFLD_ATTRIBUTE_CHAR23,'Y','Yes','No') RES_EDIT_WITH_CHANGE_REQUEST
