 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Elements%20-%20Employee%20Tax%20Credits.sql $:
 * $Id: Manage Elements - Employee Tax Credits.sql 78239 2022-04-07 15:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
,DECODE(elementsE0.ONCE_EACH_PERIOD_FLAG ,'Y','Yes','N','No') RES_PROCESS_THE_ELEMENT_ONLY_O
...
,DECODE(elementsE0.PRORATION_GROUP_ID,NULL,'No','Yes') RES_IS_THIS_ELEMENT_SUBJECT_TO
,(SELECT EVENT_GROUP_NAME
    FROM PAY_EVENT_GROUPS_TL
    WHERE LANGUAGE = USERENV('LANG')
    AND EVENT_GROUP_ID = elementsE0.PRORATION_GROUP_ID
    ) RES_PRORATION_GROUP
,DECODE(elementsE0.RECALC_EVENT_GROUP_ID,NULL,'No','Yes') RES_IS_THIS_ELEMENT_SUBJECT__0
,(SELECT EVENT_GROUP_NAME
    FROM PAY_EVENT_GROUPS_TL
    WHERE LANGUAGE = USERENV('LANG')
...
AND prClassesE0.CLASSIFICATION_NAME = 'Employee Tax Credits'
