...
* $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Legal%20Entity%20Configurator%20Descriptive%20Flexfield%20-%20Context%20Segments.sql $:
* $Id: Manage Legal Entity Configurator Descriptive Flexfield - Context Segments.sql 78284 2022-04-13 06:03:20Z pisan.jariyasettachok $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
,NVL(
	...
	),decode(ContextSegment.ENABLED_FLAG,'N','No','')) AS RES_ENABLED
,DECODE(
	...
	,FND_TABLES TableE0
	,FND_COLUMNS ColumnE0 WHERE TableUsage.FLEXFIELD_USAGE_CODE = ColumnUsageE0.TABLE_USAGE_CODE
...
WHERE ContextSegment.APPLICATION_ID = 204
