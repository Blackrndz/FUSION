...
* $Id: Manage Locations - China Details.sql 80146 2023-02-10 10:05:41Z tanawat.wongjan $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
, HEAD.town_or_city RES_PREFECTURE
, HEAD.ADDL_ADDRESS_ATTRIBUTE2 RES_COUNTY_OR_DISTRICT
, HEAD.ADDRESS_LINE_1 RES_STREET_ADDRESS
, HEAD.address_line_2 RES_ADDITIONAL_ADDRESS_LINE
