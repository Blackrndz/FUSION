...
* $Date: 2016-11-01 11:01:59 +0700 (Thu, 17 Mar 2016) $:
...
* $Id: Manage Requisition Descriptive Flexfields - Global Segments.sql 53610 2016-03-17 04:01:59Z nasrullah.dusenmahamad $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
DECODE(DescriptiveFlexfieldEO.BI_ENABLED_FLAG,'Y',NVL(
	decode(GlobalSegment.BI_ENABLED_FLAG,'Y','Yes','No'),'No'),NULL)						RES_BI_ENABLED,
...
AND GlobalSegment.CONTEXT_CODE  			= 'Global Data Elements'
AND GlobalSegment.APPLICATION_ID            = 10071
