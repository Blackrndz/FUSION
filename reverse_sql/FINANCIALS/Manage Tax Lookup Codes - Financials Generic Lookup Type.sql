 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Tax%20Lookup%20Codes%20-%20Financials%20Generic%20Lookup%20Type.sql $:
 * $Id: Manage Tax Lookup Codes - Financials Generic Lookup Type.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
WHERE fndlookups.LOOKUP_TYPE IN
	(SELECT LOOKUP_TYPE
	FROM FND_LOOKUP_TYPES_VL
	WHERE MODULE_ID = '47110F64AC1708E2E040449823C60DB6'
	)
