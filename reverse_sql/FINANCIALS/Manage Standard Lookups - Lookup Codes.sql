 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Standard%20Lookups%20-%20Lookup%20Codes.sql $:
 * $Id: Manage Standard Lookups - Lookup Codes.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
,LookupEO.LAST_UPDATED_BY as RSC_LAST_UPDATED_BY
,LookupEO.LAST_UPDATE_DATE AS RSC_LAST_UPDATE_DATE
...
ORDER BY LookupEO.DISPLAY_SEQUENCE
,LookupEO.MEANING