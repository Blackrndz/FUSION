 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Organization%20Structures%20Lookups%20for%20China%20-%20Lookup%20Codes%20-%20DFF.sql $:
 * $Id: Manage Organization Structures Lookups for China - Lookup Codes - DFF.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
AND LookupTypeEO.LOOKUP_TYPE IN
	...
	AND BoAttributeValuesEO.TASK_ID                   =
		(SELECT task_id
		FROM ASK_TASKS_VL
		WHERE TASK_SHORT_NAME = 'HRX_MANAGE_CHINESE_ENTREPRISE_STRUCTURES_LOOKUPS'
		))
	)
