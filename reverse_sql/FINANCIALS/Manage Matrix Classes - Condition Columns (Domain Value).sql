...
,(CASE
	WHEN matrixConditionsE0.DATA_TYPE_CODE = 'STRING' THEN
		matrixDomainsE0.VALUE_STRING
	WHEN matrixConditionsE0.DATA_TYPE_CODE = 'NUMBER' THEN
		TO_CHAR(matrixDomainsE0.VALUE_NUMBER)
	WHEN matrixConditionsE0.DATA_TYPE_CODE = 'DATE' THEN
		TO_CHAR(matrixDomainsE0.VALUE_DATE,'DD-Mon-YYYY')
	WHEN matrixConditionsE0.DATA_TYPE_CODE = 'TIMESTAMP' THEN
		TO_CHAR(matrixDomainsE0.VALUE_TIMESTAMP,'DD-Mon-YYYY HH12:MI:SS')
	END) RES_DOMAIN_VALUE
,matrixDomainsE0.DISPLAY_VALUE RES_DISPLAY_VALUE
,matrixDomainsE0.LAST_UPDATED_BY RSC_LAST_UPDATED_BY
,matrixDomainsE0.LAST_UPDATE_DATE RSC_LAST_UPDATE_DATE
,matrixDomainsE0.CREATED_BY  RSC_CREATED_BY
,matrixDomainsE0.CREATION_DATE  RSC_CREATION_DATE
,null RSC_LEDGER_ID
...
,QP_MATRIX_DOMAINS_VL matrixDomainsE0
...
AND matrixConditionsE0.DYNAMIC_MATRIX_DIMENSION_ID = matrixDomainsE0.DYNAMIC_MATRIX_DIMENSION_ID
ORDER BY matrixClassesE0.DYNAMIC_MATRIX_CLASS_NAME
,matrixConditionsE0.DISPLAY_SEQUENCE_NUM
,matrixConditionsE0.DYNAMIC_MATRIX_DIMENSION_NAME
,3