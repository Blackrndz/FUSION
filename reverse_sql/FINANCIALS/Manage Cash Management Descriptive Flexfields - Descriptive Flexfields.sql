...
* $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Cash%20Management%20Descriptive%20Flexfields%20-%20Descriptive%20Flexfields.sql $:
* $Id: Manage Cash Management Descriptive Flexfields - Descriptive Flexfields.sql 78284 2022-04-13 06:03:20Z pisan.jariyasettachok $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
,NVL((SELECT MEANING 
	...
	AND LOOKUP_CODE = ContextSegment.DISPLAY_TYPE),'Hidden') AS RES_DISPLAY_TYPE
...
AND DescriptiveFlexfieldEO.APPLICATION_ID             = 260
