...
SELECT --'Third Party Tax Profiles' RES_SEARCH_FOR
...
,(SELECT TERRITORY_SHORT_NAME 
	...
	AND TERRITORY_CODE = PartyPEO.COUNTRY 
	) RES_COUNTRY
,PartyPEO.JGZZ_FISCAL_CODE RES_TAXPAYER_ID
,PartyPEO.DUNS_NUMBER_C RES_D_U_N_S*/
...
,hz_format_pub.format_address(ZxPartyTaxRegistration.LEGAL_LOCATION_ID,NULL,NULL,'/',NULL,NULL,NULL,NULL) RES_LEGAL_REGISTRATION_ADDRESS
