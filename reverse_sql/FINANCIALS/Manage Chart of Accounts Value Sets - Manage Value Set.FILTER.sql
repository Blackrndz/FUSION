 ...
 * $HeadURL: http://svn01.rapidesuite.com:999/svn/a/dev/rapidesuite/controldata/FUSION_11.1.12/trunk/core/reverse_sql/FINANCIALS/Manage%20Chart%20of%20Accounts%20Value%20Sets%20-%20Manage%20Value%20Set.sql $:
 * $Id: Manage Chart of Accounts Value Sets - Manage Value Set.sql 64388 2017-10-10 10:04:06Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
select  QRSLT.VALUE_SET_CODE RES_VALUE_SET_CODE,
          ...
          DECODE(QRSLT.VALIDATION_MEANING,'Format Only',NULL,DECODE(QRSLT.SECURITY_ENABLED_FLAG,'Y','Yes','N','No')) RES_SECURITY_ENABLED,
...
AND COA.VALUE_SET_ID(+) = QRSLT.VALUE_SET_ID
order by QRSLT.VALUE_SET_CODE ,QRSLT.Validation_meaning ,QRSLT.user_module_name