...
* $Id: Manage Locations - Germany Details.sql 80146 2023-02-10 10:05:41Z tanawat.wongjan $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
, DECODE(NVL(AddressFormatE0.ADDRESS_STYLE_CODE,'POSTAL_ADDR'),'SUPP_TAX_AND_RPTNG_ADDR',HEAD.address_line_3,NULL) RES_STREET_NUMBER_EXTENSION
, HEAD.address_line_4 RES_ADDRESS_EXTENSION
, Head.postal_code RES_POSTAL_CODE
, HEAD.town_or_city RES_CITY
,(SELECT geography_name
	FROM fusion.HZ_GEOGRAPHIES GEO
	WHERE GEO.COUNTRY_CODE = HEAD.ADDL_ADDRESS_ATTRIBUTE4
	AND geography_type     = 'COUNTRY'
	) RES_COUNTRY_OF_ADDRESS
, HEAD.ADDL_ADDRESS_ATTRIBUTE1 RES_COMMENTS
