...
* $Id: Manage Locations - Switzerland Details.sql 80146 2023-02-10 10:05:41Z tanawat.wongjan $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
, DECODE(NVL(AddressFormatE0.ADDRESS_STYLE_CODE,'POSTAL_ADDR'),'SUPP_TAX_AND_RPTNG_ADDR',HEAD.ADDRESS_LINE_1,NULL) RES_COMPLEMENTARY_LINE
...
, HEAD.address_line_3 RES_POST_OFFICE_BOX_NUMBER
, Head.postal_code RES_POSTAL_CODE
, HEAD.town_or_city RES_CITY
, HEAD.region_2 RES_CANTON
, HEAD.region_1 RES_DISTRICT
