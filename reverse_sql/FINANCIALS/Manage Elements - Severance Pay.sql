 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Elements%20-%20Severance%20Pay.sql $:
 * $Id: Manage Elements - Severance Pay.sql 78239 2022-04-07 15:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
,(CASE
	WHEN legislativeDataGrpsE0.LEGISLATION_CODE = 'MX' THEN
		'Regular' 
	END) RES_ISR_TAX_CALCULATION_APPLIC -- ISR tax calculation applicable to this element?
,(CASE
	WHEN legislativeDataGrpsE0.LEGISLATION_CODE = 'MX' THEN
		'Statutory' 
...
AND prClassesE0.CLASSIFICATION_NAME = 'Severance Pay'
