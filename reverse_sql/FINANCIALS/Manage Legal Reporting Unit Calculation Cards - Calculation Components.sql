...
,(CASE WHEN deductionGrpsE0.NAME = 'Regional'
	THEN addressE0.STATE_NAME
	END) RES_STATE
,(CASE WHEN deductionGrpsE0.NAME = 'Regional'
	THEN addressE0.COUNTRY_NAME
	END) RES_COUNTY
,(CASE WHEN deductionGrpsE0.NAME = 'Regional'
	THEN addressE0.CITY_NAME
	END) RES_CITY
,(CASE
    ...
    END) RES_REFERENCE
,(CASE
	WHEN deductionGrpsE0.NAME IN ('Regional') THEN
		NULL
