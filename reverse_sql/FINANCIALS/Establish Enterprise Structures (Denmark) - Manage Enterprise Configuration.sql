 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Establish%20Enterprise%20Structures%20(Denmark)%20-%20Manage%20Enterprise%20Configuration.sql $:
 * $Id: Establish Enterprise Structures (Denmark) - Manage Enterprise Configuration.sql 79803 2022-12-09 08:39:48Z tanawat.wongjan $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
  ...
  HrwLocationsEO.ADDRESS_LINE1 RES_STREET_NAME_AND_NUMBER,
  HrwLocationsEO.ADDRESS_LINE2 RES_ADDITIONAL_INFORMATION,
  HrwLocationsEO.TOWN_OR_CITY RES_TOWN,
...
AND LegalEntityEO.COUNTRY_CODE = 'DK'
