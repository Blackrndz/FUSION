...
* $HeadURL: http://svn01.rapidesuite.com:999/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Contact%20Point%20Descriptive%20Flexfields%20-%20Context%20Sensitive%20Segments.sql $:
* $Id: Manage Contact Point Descriptive Flexfields - Context Sensitive Segments.sql 62193 2017-05-12 10:05:45Z pisan.jariyasettachok $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
WHERE DescriptiveFlexfieldContextE1.APPLICATION_ID = ContextSegment.APPLICATION_ID
...
AND ContextSegment.DESCRIPTIVE_FLEXFIELD_CODE = 'HZ_LOCATIONS'
