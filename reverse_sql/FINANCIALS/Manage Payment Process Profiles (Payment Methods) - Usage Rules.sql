...
,  decode(pm.applicable_value_to ,'','All','Specify')       			RES_PAYMENT_METHODS_OPTION
, ( select PAYMENT_METHOD_NAME 
	from  IBY_PAYMENT_METHODS_VL IbyPaymentMethodsVl
	where PAYMENT_METHOD_CODE =  pm.applicable_value_to     )           RES_PAYMENT_METHODS_NAME
, pm.applicable_value_to	RES_PAYMENT_METHODS_CODE
...
AND  pm.applicable_type_code  = 'PAYMENT_METHOD'
