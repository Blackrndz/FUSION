...
,(SELECT TERRITORY_SHORT_NAME
    ...
    WHERE TERRITORY_CODE = benELIGGENCRITEO.CRIT_CHAR1
    ) RES_COUNTRY
,benELIGGENCRITEO.CRIT_CHAR2 RES_STATE
,benELIGGENCRITEO.CRIT_CHAR3 RES_CITY
...
,DECODE(benELIGGENCRITEO.CRIT_CHAR5,'Y','Yes','No') RES_PRIMARY
...
AND benELIGGENCRITEO.ELIG_CRITERIA_CODE = 'GEO'
