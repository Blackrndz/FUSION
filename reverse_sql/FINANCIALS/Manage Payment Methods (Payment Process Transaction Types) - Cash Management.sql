...
,(SELECT  TransactionTypeEO.NAME
    ...
    WHERE TransactionTypeEO.APPLICATION_ID = 260 
    and  TransactionTypeEO.PAY_PROC_TRXN_TYPE_CODE = IbyApplicablePmtMthds.APPLICABLE_VALUE_TO 
	) RES_TYPE
...
,IBY_APPLICABLE_PMT_MTHDS IbyApplicablePmtMthds
...
AND IbyApplicablePmtMthds.APPLICATION_ID = 260
