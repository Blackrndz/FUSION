 ...
 * ************************************************************************** */
  ...
  HrwLocationsEO.ADDRESS_LINE1 AS RES_BLOCK_OR_HOUSE_NUMBER,
  HrwLocationsEO.ADDRESS_LINE2 AS RES_STREET_NAME,
  HrwLocationsEO.ADDRESS_LINE3 AS RES_LEVEL_UNIT_NUMBER,
  HrwLocationsEO.BUILDING AS RES_BUILDING_NAME,
...
AND LegalEntityEO.COUNTRY_CODE = 'SG'
