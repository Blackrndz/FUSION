 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Functional%20Area%20Catalogs%20-%20Functional%20Area%20Catalog.sql $:
 * $Id: Manage Functional Area Catalogs - Functional Area Catalog.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
,DECODE(QRSLT.PUBLIC_CATALOG,'Y','Yes','No') RES_PUBLIC
,'Yes' RES_ASSIGN_ITEMS_TO_LEAF_LEVEL
,'No' RES_ENABLE_DUPLICATE_CATEGORY_
,DECODE(QRSLT.MULT_ITEM_CAT_ASSIGN_FLAG,'Y','Yes','No') RES_ALLOW_MULTIPLE_ITEM_CATEGO
,'No' RES_ENABLE_DELETION_OF_ITEM_CA
,DECODE(QRSLT.HIERARCHY_ENABLED,'Y','Yes','No') RES_ENABLE_HIERARCHY_FOR_CATAL
