...
,TO_CHAR(autoE0.EFFECTIVE_START_DATE,'DD-Mon-YYYY') RES_EFFECTIVE_START_DATE
,(SELECT ELEMENT_NAME 
	FROM PAY_ELEMENT_TYPES_TL 
	WHERE ELEMENT_TYPE_ID = autoE0.TARGET_ELEMENT_TYPE_ID  
	AND LANGUAGE = USERENV('LANG')
	)RES_TARGET_ELEMENT
,(SELECT FORMULA_NAME
    FROM FF_FORMULAS_TL
    WHERE LANGUAGE = USERENV('LANG')
    AND FORMULA_ID = autoE0.FORMULA_ID
    ) RES_FORMULA
,DECODE(TO_CHAR(autoE0.EFFECTIVE_END_DATE ,'DD-MM-YYYY'),'31-12-4712',NULL,TO_CHAR(autoE0.EFFECTIVE_END_DATE ,'DD-Mon-YYYY')) RES_EFFECTIVE_END_DATE

,autoE0.LAST_UPDATED_BY RSC_LAST_UPDATED_BY
,autoE0.LAST_UPDATE_DATE RSC_LAST_UPDATE_DATE
,autoE0.CREATED_BY RSC_CREATED_BY
,autoE0.CREATION_DATE RSC_CREATION_DATE
,NULL RSC_LEDGER_ID
...
AND elementsE0.ELEMENT_TYPE_ID = autoE0.ELEMENT_TYPE_ID
