...
* $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Job%20Requisition%20Descriptive%20Flexfields%20-%20Context%20Segments.sql $:
* $Id: Manage Job Requisition Descriptive Flexfields - Context Segments.sql 78284 2022-04-13 06:03:20Z pisan.jariyasettachok $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
WHERE ContextSegment.APPLICATION_ID = 821
...
AND(DescriptiveFlexfieldEO.module_id     IN
	...
	AND t.module_key         IN ('HcmRecHiringReqsCore')
	))
