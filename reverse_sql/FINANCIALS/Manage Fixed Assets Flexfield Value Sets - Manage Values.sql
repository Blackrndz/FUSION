...
* $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Fixed%20Assets%20Flexfield%20Value%20Sets%20-%20Manage%20Values.sql $:
* $Id: Manage Fixed Assets Flexfield Value Sets - Manage Values.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
* ****************************************************************************
* Description:
* ************************************************************************** */

SELECT DISTINCT * FROM (SELECT ValueSetPEO.VALUE_SET_CODE AS RES_VALUE_SET_CODE
...
AND ValueSetPEO.MODULE_ID in (select MODULE_ID  from FND_APPL_TAXONOMY_VL where IS_SEED_DATA_ALLOWED = 'Y' and MODULE_NAME like 'FinFa%')
--AND ValueSetPEO.MODULE_ID = '47110F64AC0708E2E040449823C60DB6'
UNION ALL
