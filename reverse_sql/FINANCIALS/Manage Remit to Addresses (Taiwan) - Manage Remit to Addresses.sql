 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Remit%20to%20Addresses%20(Taiwan)%20-%20Manage%20Remit%20to%20Addresses.sql $:
 * $Id: Manage Remit to Addresses (Taiwan) - Manage Remit to Addresses.sql 79973 2023-01-16 04:29:30Z tanawat.wongjan $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
, remitToLocs.location_id                                                         AS RES_SITE_NUMBER
 ...
 loc.CITY RES_CITY,
 loc.ADDR_ELEMENT_ATTRIBUTE1 RES_ADDITIONAL_ADDRESS_ATTRIBU,
