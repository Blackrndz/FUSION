...
,(SELECT * 
	...
	WHERE KEY_TYPE = 'PLAN'
	AND ATTRIBUTE_NAME = 'CMP_CWB_WORKSHEET_TABS'
	) actionsE0
WHERE cmpPLANEO.COMP_TYPE = 'CWB'
AND cmpPLANEO.PLAN_ID = actionsE0.KEY_VALUE
AND (actionsE0.DISPLAY_NAME IS NOT NULL
	OR actionsE0.ORDER_NUM IS NOT NULL
	OR actionsE0.TEXT_VALUE1 IS NOT NULL)
