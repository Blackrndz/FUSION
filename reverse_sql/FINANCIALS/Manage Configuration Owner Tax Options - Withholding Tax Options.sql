...
FROM
	(SELECT TaxOption.PARTY_NAME
	,TaxOption.PARTY_TYPE_NAME 
	,TaxOption.LAST_UPDATED_BY 
	,TaxOption.LAST_UPDATE_DATE 
	,TaxOption.CREATED_BY 
	,TaxOption.CREATION_DATE 
	,TaxOption.INDIRECT_TAX_OR_WHT_FLAG
	,ROW_NUMBER() OVER (PARTITION BY TaxOption.PARTY_NAME, TaxOption.PARTY_TYPE_NAME ORDER BY TaxOption.PARTY_NAME) LINE
	,TaxOption.party_type_code 
	,TaxOption.BU_ID 
	,TaxOption.LEGAL_ENTITY_ID 
	FROM
