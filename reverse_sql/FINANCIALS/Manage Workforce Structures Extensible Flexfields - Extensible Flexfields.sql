 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Workforce%20Structures%20Extensible%20Flexfields%20-%20Extensible%20Flexfields.sql $:
 * $Id: Manage Workforce Structures Extensible Flexfields - Extensible Flexfields.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
AND flexfieldsE0.DESCRIPTIVE_FLEXFIELD_CODE IN
	...
	AND BoAttributeValuesEO.TASK_ID                   =
		(SELECT task_id
		FROM ASK_TASKS_VL
		WHERE TASK_SHORT_NAME = 'ORA_PER_MANAGE_WORKFORCE_STRUCTURES_EXTENSIBLE_FLEXFIELDS'))
		)
