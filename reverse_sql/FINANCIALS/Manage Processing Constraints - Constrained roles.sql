...
,RolesE0.ROLE_NAME RES_ROLE
,RolesE0.DESCRIPTION RES_DESCRIPTION
,pcAssignmentsE0.LAST_UPDATED_BY RSC_LAST_UPDATED_BY
,pcAssignmentsE0.LAST_UPDATE_DATE RSC_LAST_UPDATE_DATE
,pcAssignmentsE0.CREATED_BY RSC_CREATED_BY
,pcAssignmentsE0.CREATION_DATE RSC_CREATION_DATE
,null RSC_LEDGER_ID
...
,DOO_PC_ASSIGNMENTS_F pcAssignmentsE0
,PER_ROLES_DN_VL RolesE0
WHERE pcConstraintsE0.CONSTRAINT_ID  = pcAssignmentsE0.CONSTRAINT_ID 
AND pcAssignmentsE0.ROLE_ID = RolesE0.ROLE_ID
