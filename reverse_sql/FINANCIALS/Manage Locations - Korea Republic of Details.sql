...
* $Id: Manage Locations - Korea Republic of Details.sql 80146 2023-02-10 10:05:41Z tanawat.wongjan $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
, DECODE(NVL(AddressFormatE0.ADDRESS_STYLE_CODE,'POSTAL_ADDR'),'SUPP_TAX_AND_RPTNG_ADDR',HEAD.town_or_city,NULL) RES_CITY_OR_PROVINCE
, DECODE(NVL(AddressFormatE0.ADDRESS_STYLE_CODE,'POSTAL_ADDR'),'SUPP_TAX_AND_RPTNG_ADDR',HEAD.ADDL_ADDRESS_ATTRIBUTE2,NULL) RES_DISTRICT
, HEAD.ADDRESS_LINE_1 RES_ADDRESS_LINE_1
, HEAD.address_line_2 RES_ADDRESS_LINE_2
, HEAD.ADDL_ADDRESS_ATTRIBUTE3 RES_NEIGHBORHOOD
, DECODE(NVL(AddressFormatE0.ADDRESS_STYLE_CODE,'POSTAL_ADDR'),'POSTAL_ADDR',HEAD.ADDL_ADDRESS_ATTRIBUTE2,NULL) RES_DISTRICTWARD
