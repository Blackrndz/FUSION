 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Asset%20Books%20-%20Revaluation%20Rules.sql $:
 * $Id: Manage Asset Books - Revaluation Rules.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
,DECODE(QRSLT.ALLOW_REVAL_FLAG,'YES','Yes','No') RES_ALLOW_REVALUATION
,DECODE(QRSLT.ALLOW_COST_BASED_REVAL_FLAG,'Y','Yes','No') RES_COST
,DECODE(QRSLT.ALLOW_NBV_BASED_REVAL_FLAG,'Y','Yes','No') RES_NET_BOOK_VALUE
,DECODE(QRSLT.REVAL_DEPRN_RESERVE_FLAG,'YES','Yes','No') RES_REVALUE_DEPRECIATION_RESER
,DECODE(QRSLT.REVAL_YTD_DEPRN_FLAG,'YES','Yes','No') RES_REVALUE_YTD_DEPRECIATION
,DECODE(QRSLT.AMORTIZE_REVAL_RESERVE_FLAG,'YES','Yes','No') RES_AMORTIZE_REVALUATION_RESER
,DECODE(QRSLT.RETIRE_REVAL_RESERVE_FLAG,'YES','Yes','No') RES_RETIRE_REVALUATION_RESERVE
,DECODE(QRSLT.DEFAULT_PERIOD_END_REVAL_FLAG,'Y','Yes','No') RES_INCLUDE_CURRENT_PERIOD_DEP
,DECODE(QRSLT.DEFAULT_REVAL_FULLY_RSVD_FLAG,'YES','Yes','No') RES_REVALUE_FULLY_RESERVED_ASS
,QRSLT.DEFAULT_LIFE_EXTENSION_FACTOR RES_LIFE_EXTENSION_FACTOR
,QRSLT.DEFAULT_MAX_FULLY_RSVD_REVALS RES_MAXIMUM_REVALUATIONS
,QRSLT.DEFAULT_LIFE_EXTENSION_CEILING RES_LIFE_EXTENSION_CEILING
,DECODE(QRSLT.ALLOW_FUND_ACCOUNTING_FLAG,'Y','Yes','No')	 RES_ALLOW_CAPITAL_FUND_ACCOUNT
