...
,QRSLT.CALENDAR_NAME ||' '|| (SELECT DESCRIPTION FROM AP_OTHER_PERIOD_TYPES WHERE CALENDAR_NAME = QRSLT.CALENDAR_NAME) RES_WITHHOLDING_TAX_CALENDAR
,(SELECT Meaning
	FROM fnd_lookup_values_vl
...
,(SELECT Meaning
	...
	AND lookup_code   = QRSLT.TXBL_BSIS_THRSHLD_HNDLNG_FLAG
