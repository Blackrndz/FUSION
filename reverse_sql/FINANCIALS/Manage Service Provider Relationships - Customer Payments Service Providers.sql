 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Service%20Provider%20Relationships%20-%20Customer%20Payments%20Service%20Providers.sql $:
 * $Id: Manage Service Provider Relationships - Customer Payments Service Providers.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
WHERE     BUServiceProviderEO.PROVIDER_BU_ORG_ID              = BusinessUnitPEO.BU_ID
          ...
          AND
          (
                    UpstreamBusinessFunction.BUSINESS_FUNCTION_CODE = 'BILLING_REVENUE_MNG_BF'
          )
          AND
          (
                    DownstreamBusinessFunction.BUSINESS_FUNCTION_CODE = 'CUSTOMER_PAYMENTS_BF'
          )
