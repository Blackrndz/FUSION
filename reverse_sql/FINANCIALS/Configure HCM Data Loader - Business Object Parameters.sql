...
SELECT 'Data Loader Parameters' RES_DATA_TYPE
,parametersE0.BUS_OBJ_TOP_DISCRIMINATOR RES_BUSINESS_OBJECT
...
AND parametersE0.BUS_OBJ_TOP_DISCRIMINATOR IS NOT NULL
AND parametersE0.HDL_ENABLED = 'Y'

UNION

SELECT 'Spreadsheet Data Loader Parameters' RES_DATA_TYPE
,parametersE0.BUS_OBJ_TOP_DISCRIMINATOR RES_BUSINESS_OBJECT
,paramNamesE0.MEANING RES_PARAMETER
,(CASE
	WHEN parametersE0.VALUE_LOOKUP_TYPE IS NOT NULL THEN
