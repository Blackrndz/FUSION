...
,(SELECT NAME 
	...
	WHERE benELIGGENCRITEO.END_DATE BETWEEN EFFECTIVE_START_DATE AND NVL(EFFECTIVE_END_DATE,TO_DATE('4712-12-31','YYYY-MM-DD'))
	AND ORGANIZATION_ID = benELIGGENCRITEO.CRIT_NUMBER1
	) RES_UNION_NAME
...
AND benELIGGENCRITEO.ELIG_CRITERIA_CODE = 'UNN'
