...
,PayFlowSecurityProfileEO.Name RES_PAYROLL_FLOW_SECURITY_PROF
,PayFlowSecurityProfileEO.Name RES_NAME_BASIC_DETAILS
,PayFlowSecurityProfileEO.PayFlowFlag RES_ENABLED
,PayFlowSecurityProfileEO.PayFlowVA RES_VIEW_ALL
...
,(SELECT PayFlow.Name
	,DECODE(PayFlow.ENABLED_FLAG, 'Y', 'Yes', 'No') PayFlowFlag
	,DECODE(PayFlow.VIEW_ALL, 'Y', 'Yes', 'No') PayFlowVA
	,PayFlow.CREATED_BY
	,PayFlow.CREATION_DATE
	,PayFlow.LAST_UPDATED_BY
	,PayFlow.LAST_UPDATE_DATE
	,PayFlow.BUSINESS_GROUP_ID
