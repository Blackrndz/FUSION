...
* $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Project%20Templates%20-%20Project%20Plan%20Asset%20Assignments.sql $:
* $Id: Manage Project Templates - Project Plan Asset Assignments.sql 78557 2022-05-24 03:32:18Z tanawat.wongjan $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
,(SELECT PROJECT_ID
	...
	--AND TASK_ID = projElementsE0.DENORM_TOP_ELEMENT_ID
	) projAssetAssignE1
...
AND projElementsE0.PROJECT_ID = projAssetAssignE1.PROJECT_ID(+)
AND projElementsE0.DENORM_TOP_ELEMENT_ID = projAssetAssignE1.TASK_ID(+)
AND EXISTS (SELECT 1
