...
,TO_CHAR(elementtypeuseE0.EFFECTIVE_START_DATE,'DD-Mon-YYYY') RES_EFFECTIVE_START_DATE
,(SELECT RUN_TYPE_NAME FROM PAY_RUN_TYPES_VL WHERE RUN_TYPE_ID = elementtypeuseE0.RUN_TYPE_ID 
	AND SYSDATE BETWEEN EFFECTIVE_START_DATE AND NVL(EFFECTIVE_END_DATE,TO_DATE('4712-12-31','YYYY-MM-DD')))RES_RUN_TYPE
,(SELECT MEANING
    FROM FND_LOOKUP_VALUES
    WHERE LANGUAGE = USERENV('LANG')
    AND LOOKUP_TYPE = 'PAY_ELEMENT_USAGE_TYPE'
    AND LOOKUP_CODE = elementtypeuseE0.USAGE_TYPE
    ) RES_ELEMENT_USAGE
,DECODE(TO_CHAR(elementtypeuseE0.EFFECTIVE_END_DATE ,'DD-MM-YYYY'),'31-12-4712',NULL,TO_CHAR(elementtypeuseE0.EFFECTIVE_END_DATE ,'DD-Mon-YYYY')) RES_EFFECTIVE_END_DATE

,elementtypeuseE0.LAST_UPDATED_BY RSC_LAST_UPDATED_BY
,elementtypeuseE0.LAST_UPDATE_DATE RSC_LAST_UPDATE_DATE
,elementtypeuseE0.CREATED_BY RSC_CREATED_BY
,elementtypeuseE0.CREATION_DATE RSC_CREATION_DATE
,NULL RSC_LEDGER_ID
...
,PAY_ELEMENT_TYPE_USAGES_F elementtypeuseE0
,(SELECT NAME
...
AND elementsE0.ELEMENT_TYPE_ID = elementtypeuseE0.ELEMENT_TYPE_ID
