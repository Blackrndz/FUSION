...
* $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Financial%20Plan%20Types%20-%20Revenue%20Options%20-%20DFF.sql $:
* $Id: Manage Financial Plan Types - Revenue Options - DFF.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
WHERE planTypesE0.PLAN_TYPE_CODE = 'FINANCIAL_PLAN'
AND planTypesE0.PLAN_OPTION_CODE = 'REVENUE_ONLY'
