...
* $HeadURL: http://svn01.rapidesuite.com:999/svn/a/dev/rapidesuite/controldata/FUSION_11.1.9/trunk/customized/In%20Develop/reverse_sql/Manage%20Expense%20Fields%20by%20Category%20-%20Accommodations.sql $:
* $Id: Manage Expense Fields by Category - Accommodations.sql 61485 2017-03-21 10:10:25Z chanatip.buabhom $:
* ****************************************************************************
* Description:
* ************************************************************************** */


SELECT 'Yes' RES_ENABLE_FIELDS_FOR_ACCOMMOD
...
,decode(CategoryFieldEO.END_DATE_FIELD,'ENABLED','Optional','DISABLED','Hidden','REQUIRED','Required') RES_CHECKOUT_DATE
...
and Category_code = 'ACCOMMODATIONS'
