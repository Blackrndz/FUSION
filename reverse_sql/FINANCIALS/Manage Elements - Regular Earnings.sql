 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Elements%20-%20Regular%20Earnings.sql $:
 * $Id: Manage Elements - Regular Earnings.sql 78239 2022-04-07 15:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
,(CASE
	WHEN EXISTS (SELECT 1 FROM PAY_INPUT_VALUES_VL WHERE ELEMENT_TYPE_ID = elementsFE0.ELEMENT_TYPE_ID AND NAME = 'Unit Type' AND DEFAULT_VALUE = 'H') THEN 
		'Yes'
	END) RES_SHOULD_THIS_ELEMENT_BE_I_1	-- Should this element be included in the hours calculation of the FLSA overtime base rate?
,'' RES_RATE_NAME
...
AND prClassesE0.CLASSIFICATION_NAME = 'Regular Earnings'
