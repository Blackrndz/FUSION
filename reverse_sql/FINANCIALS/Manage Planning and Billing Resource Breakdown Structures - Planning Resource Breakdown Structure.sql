...
,(SELECT NAME
    ...
    WHERE ORGANIZATION_ID = resourcesE0.PROJECT_UNIT_ID
    ) RES_PROJECT_UNIT
,DECODE(resourcesE0.CENTRALLY_CONTROL_FLAG,'N','Yes','No') RES_ALLOW_RESOURCE_CHANGES_AT_
,DECODE(resourcesE0.AUTO_ADD_RES_FLAG,'Y','Yes','No') RES_AUTOMATICALLY_ADD_RESOURCE
,(SELECT SET_NAME
    FROM FND_SETID_SETS
