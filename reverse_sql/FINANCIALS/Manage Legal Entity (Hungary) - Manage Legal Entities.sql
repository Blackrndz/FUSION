...
* $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Legal%20Entity%20(Hungary)%20-%20Manage%20Legal%20Entities.sql $:
* $Id: Manage Legal Entity (Hungary) - Manage Legal Entities.sql 78399 2022-04-29 08:46:30Z tanawat.wongjan $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
,XleRegistrations.REGISTRATION_NUMBER   AS RES_CEGSZAM
,(SELECT REGISTRATION_NUMBER
...
AND TerritoryPEO.TERRITORY_CODE         = 'HU'
ORDER BY RES_NAME