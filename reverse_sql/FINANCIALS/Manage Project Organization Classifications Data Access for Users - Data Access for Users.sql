...
,'Project organization classification' RES_SECURITY_CONTEXT
,(SELECT NAME
	FROM HR_ALL_ORGANIZATION_UNITS
	WHERE ORGANIZATION_ID = UserRoleE0.PRJ_ORGANIZATION_ID
...
,(CASE
	WHEN EXISTS (SELECT 1 FROM HR_ORG_UNIT_CLASSIFICATIONS_F WHERE ORGANIZATION_ID = UserRoleE0.PRJ_ORGANIZATION_ID AND CLASSIFICATION_CODE = 'FUN_BUSINESS_UNIT') THEN
		UserRoleE0.PRJ_ORGANIZATION_ID
	END) RSC_BUSINESS_UNIT_ID
,null RSC_LEGAL_ENTITY_ID
,(CASE
	WHEN NOT EXISTS (SELECT 1 FROM HR_ORG_UNIT_CLASSIFICATIONS_F WHERE ORGANIZATION_ID = UserRoleE0.PRJ_ORGANIZATION_ID AND CLASSIFICATION_CODE = 'FUN_BUSINESS_UNIT') THEN
		UserRoleE0.PRJ_ORGANIZATION_ID
...
AND UserRoleE0.PRJ_ORGANIZATION_ID IS NOT NULL
