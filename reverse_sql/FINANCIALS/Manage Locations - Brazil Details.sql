...
* $Id: Manage Locations - Brazil Details.sql 80146 2023-02-10 10:05:41Z tanawat.wongjan $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
, HEAD.ADDRESS_LINE_1 RES_ADDRESS
, HEAD.ADDL_ADDRESS_ATTRIBUTE3 RES_ADDRESS_SITE
, HEAD.ADDRESS_LINE_1 RES_ADDRESS_LINE_1
, HEAD.address_line_2 RES_ADDRESS_LINE_2
, HEAD.address_line_2 RES_NUMBER
, HEAD.BUILDING RES_COMPLEMENT
, HEAD.address_line_3 RES_NEIGHBORHOOD
, HEAD.town_or_city RES_CITY
, HEAD.region_2 RES_STATE_UF
