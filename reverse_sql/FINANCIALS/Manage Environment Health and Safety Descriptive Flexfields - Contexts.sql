...
* $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Environment%20Health%20and%20Safety%20Descriptive%20Flexfields%20-%20Contexts.sql $:
* $Id: Manage Environment Health and Safety Descriptive Flexfields - Contexts.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
,DescriptiveFlexfieldContextE1.CREATED_BY  AS RSC_CREATED_BY
,DescriptiveFlexfieldContextE1.CREATION_DATE AS RSC_CREATION_DATE
...
WHERE DescriptiveFlexfieldEO.APPLICATION_ID = 800
AND DescriptiveFlexfieldEO.DESCRIPTIVE_FLEXFIELD_CODE NOT IN ('PER_PERSON_DISABILITY_LEG_DDF')
AND(DescriptiveFlexfieldEO.module_id     IN
	...
	AND t.module_key         = ('HcmPeopleHealthAndSafety')
	))
