...
,(SELECT NAME FROM HR_ALL_ORGANIZATION_UNITS
    WHERE ORGANIZATION_ID = gmsAWARDDEPARTCRE0.ORGANIZATION_ID) RES_ORGANIZATION
,gmsAWARDDEPARTCRE0.DEPARTMENT_CREDIT RES_PERCENTAGE

,gmsAWARDDEPARTCRE0.LAST_UPDATED_BY RSC_LAST_UPDATED_BY
,gmsAWARDDEPARTCRE0.LAST_UPDATE_DATE RSC_LAST_UPDATE_DATE
,gmsAWARDDEPARTCRE0.CREATED_BY RSC_CREATED_BY
,gmsAWARDDEPARTCRE0.CREATION_DATE RSC_CREATION_DATE
,null RSC_LEDGER_ID
...
,GMS_AWARD_DEPARTMENT_CREDITS gmsAWARDDEPARTCRE0
WHERE gmsAWARDTEMPE0.AWARD_HEADER_ID = gmsAWARDHEABE0.ID
AND gmsAWARDHEABE0.ID = gmsAWARDDEPARTCRE0.AWARD_ID
