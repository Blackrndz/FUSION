...
* $Date: 2023-01-31 10:50:13 +0700 (Tue, 31 Jan 2023) $:
...
,(SELECT PAYROLL_NAME FROM PAY_ALL_PAYROLLS_F WHERE PAYROLL_ID = benELIGPYRLEO.PAYROLL_ID
	AND SYSDATE BETWEEN EFFECTIVE_START_DATE AND NVL(EFFECTIVE_END_DATE,TO_DATE('4712-12-31','YYYY-MM-DD'))) RES_PAYROLL_NAME
