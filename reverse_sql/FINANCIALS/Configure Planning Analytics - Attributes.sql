...
,LevelsE0.LEVEL_POS_NUM RES_LEVEL
,HierarchiesE0.NAME RES_HIERARCHY_NAME
,LevelsE0.NAME RES_DEFAULT_LEVEL_NAME
,LevelAttrsE0.ATTRIBUTE_NAME RES_ATTRIBUTE
,LevelAttrsE0.LABEL RES_ATTRIBUTE_LABEL
,LevelAttrsE0.LAST_UPDATED_BY RSC_LAST_UPDATED_BY
,LevelAttrsE0.LAST_UPDATE_DATE RSC_LAST_UPDATE_DATE
,LevelAttrsE0.CREATED_BY RSC_CREATED_BY
,LevelAttrsE0.CREATION_DATE RSC_CREATION_DATE
,NULL RSC_LEDGER_ID
