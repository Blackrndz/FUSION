 ...
 * $Date: 2017-10-10 17:04:06 +0700 (Tue, 10 Oct 2017) $:
 * $HeadURL: http://svn01.rapidesuite.com:999/svn/a/dev/rapidesuite/controldata/FUSION_11.1.12/trunk/core/reverse_sql/FINANCIALS/Manage%20Chart%20of%20Accounts%20Value%20Set%20Values%20-%20Manage%20Values.sql $:
 * $Id: Manage Chart of Accounts Value Set Values - Manage Values.sql 64388 2017-10-10 10:04:06Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
,decode(decode(Head.VALIDATION_MEANING,'Subset',SubsetValue.ENABLED_FLAG,Detail.ENABLED_FLAG),'Y','Yes','N','No')         RES_ENABLED
...
AND COA.VALUE_SET_ID(+) = Head.VALUE_SET_ID
