...
With QRSLT as (SELECT ValueSetEO.VALUE_SET_ID
	...
	,ValidationTypeLookupPEO.LOOKUP_TYPE as aLOOKUP_TYPE
	,ValidationTypeLookupPEO.LOOKUP_CODE as aLOOKUP_code
	,ValidationTypeLookupPEO.MEANING as ameaning
	,ValueDataTypeLookupPEO.LOOKUP_TYPE as bLOOKUP_TYPE
	,ValueDataTypeLookupPEO.LOOKUP_CODE as bLOOKUP_code
	,ValueDataTypeLookupPEO.MEANING as bmeaning
