 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Allow%20People%20with%20Future%20Effective%20Start%20Dates%20as%20Project%20Members%20-%20Profile%20Options.sql $:
 * $Id: Allow People with Future Effective Start Dates as Project Members - Profile Options.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
and PROFILEOPTIONEO.PROFILE_OPTION_NAME in (select BOATTRIBUTEVALUESEO.BO_ATTRIBUTE_VALUE
														...
														AND BoAttributeValuesEO.TASK_ID  IN
															(SELECT task_id
															FROM ASK_TASKS_VL
															where TASK_SHORT_NAME = 'PJF_ALLOW_FUTUREDATED_PEOPLE_PROJECT_MEMBERS_PROFILE_OPT'
															))
