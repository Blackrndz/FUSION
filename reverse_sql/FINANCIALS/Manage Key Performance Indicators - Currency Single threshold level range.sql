...
WITH TMPpjsPERFTHRESEO AS 
	(SELECT THRES_OBJ_ID,FROM_VALUE,TO_VALUE,CURRENCY_CODE,INDICATOR_CODE,LAST_UPDATED_BY
...
SELECT pjsPERFRULEEO.RULE_NAME RES_KPI_NAME
,TMPpjsPERFTHRESEO.CURRENCY_CODE RES_CURRENCY_CODE
,TMP1.FROM_VALUE RES_THRESHOLD_START
,TMP1.TO_VALUE RES_THRESHOLD_END
