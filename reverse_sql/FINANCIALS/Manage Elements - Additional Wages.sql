 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Elements%20-%20Additional%20Wages.sql $:
 * $Id: Manage Elements - Additional Wages.sql 78239 2022-04-07 15:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
,(CASE
	...
	END) RES_WORK_UNITS_CONVERSION_RULE -- Work Units Conversion Rule
...
AND prClassesE0.CLASSIFICATION_NAME = 'Additional Wages'
