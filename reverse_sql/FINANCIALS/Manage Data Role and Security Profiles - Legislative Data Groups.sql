...
,LDGSecurityProfileEO.Name RES_NAME_BASIC_DETAILS
,LDGSecurityProfileEO.LDGName RES_NAME_LEGISLATIVE_DATA_GROU
...
,LDGSecurityProfileEO.BUSINESS_GROUP_ID RSC_BUSINESS_GROUP_ID
...
,(SELECT LDGE0.Name
	,LDGDataGroup.Name LDGName
	,LDGE0.CREATED_BY
	,LDGE0.CREATION_DATE
	,LDGE0.LAST_UPDATED_BY
	,LDGE0.LAST_UPDATE_DATE
	,LDGE0.BUSINESS_GROUP_ID
	,DataE0.GENERATED_DATA_ROLE_ID
	FROM PER_LDG_SECURITY_PROFILES LDGE0
	,PER_LDG_SECURITY_PROFILE_LDGS LDGProf
	,PER_LEGISLATIVE_DATA_GROUPS_TL LDGDataGroup
	,PER_GEN_DATA_ROLE_PROFILES DataE0
	WHERE DataE0.SECURITY_PROFILE_ID = LDGE0.LDG_SECURITY_PROFILE_ID
	AND LDGE0.LDG_SECURITY_PROFILE_ID = LDGProf.LDG_SECURITY_PROFILE_ID
	AND LDGProf.LEGISLATIVE_DATA_GROUP_ID = LDGDataGroup.LEGISLATIVE_DATA_GROUP_ID
