...
,(SELECT CURRENCY_CODE||' - '||NAME
	...
	AND CURRENCY_CODE = apCurrencyGroupsE0.CURRENCY_CODE
	) RES_CURRENCY
,apCurrencyGroupsE0.LAST_UPDATED_BY RSC_LAST_UPDATED_BY
,apCurrencyGroupsE0.LAST_UPDATE_DATE RSC_LAST_UPDATE_DATE
,apCurrencyGroupsE0.CREATED_BY RSC_CREATED_BY
,apCurrencyGroupsE0.CREATION_DATE RSC_CREATION_DATE
,NULL RSC_LEDGER_ID
...
,AP_CURRENCY_GROUP apCurrencyGroupsE0
WHERE apTemplatesE0.TEMPLATE_ID = apCurrencyGroupsE0.TEMPLATE_ID
