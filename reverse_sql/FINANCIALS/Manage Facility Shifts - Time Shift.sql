...
* $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Facility%20Shifts%20-%20Time%20Shift.sql $:
* $Id: Manage Facility Shifts - Time Shift.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
SELECT Distinct Head.SHIFT_NAME          																		RES_NAME,
	...
	TO_CHAR(TO_DATE('1970-01-01 00','yyyy-mm-dd hh24') +(Head.START_TIME_MS_NUM)/1000/60/60/24 , 'HH24:MI:SS')  RES_START_TIME,
	...
	DECODE(Head.shift_dtl_type_code,'NONE','None','FLEX','Flexible','PUNCH','Punch')   							RES_SHIFT_DETAIL_TYPE
