 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Configure%20Legislations%20for%20Human%20Resources%20-%20Payroll%20Relationship%20Type%20Mapping.sql $:
 * $Id: Configure Legislations for Human Resources - Payroll Relationship Type Mapping.sql 78239 2022-04-07 15:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
,(SELECT MEANING 
	...
	WHERE LOOKUP_CODE = payRELMAPEO.SYSTEM_PERSON_TYPE
...
,(SELECT RELATIONSHIP_TYPE_NAME 
	FROM PAY_RELATIONSHIP_TYPES_TL 
	WHERE RELATIONSHIP_TYPE_ID = payRELTYPEO.RELATIONSHIP_TYPE_ID 
	AND LANGUAGE = USERENV('LANG')
	)RES_PAYROLL_RELATIONSHIP_TYPE
...
ORDER BY 1,payRELMAPEO.SYSTEM_PERSON_TYPE