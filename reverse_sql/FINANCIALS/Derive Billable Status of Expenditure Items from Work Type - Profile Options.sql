 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Derive%20Billable%20Status%20of%20Expenditure%20Items%20from%20Work%20Type%20-%20Profile%20Options.sql $:
 * $Id: Derive Billable Status of Expenditure Items from Work Type - Profile Options.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
and PROFILEOPTIONEO.PROFILE_OPTION_NAME in (select BOATTRIBUTEVALUESEO.BO_ATTRIBUTE_VALUE
														...
														AND BoAttributeValuesEO.TASK_ID  IN
															(SELECT task_id
															FROM ASK_TASKS_VL
															where TASK_SHORT_NAME = 'PJC_DERIVE_BILLABLE_STATUS_OF_EXPENDITURE_ITEMS_FROM_WORK_TYPE'
															))
