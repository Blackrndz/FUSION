...
,CountrySecurityProfileEO.Name RES_NAME_BASIC_DETAILS
,CountrySecurityProfileEO.CountryFlag RES_ENABLED
,CountrySecurityProfileEO.CountryVA RES_VIEW_ALL
...
,CountrySecurityProfileEO.BUSINESS_GROUP_ID RSC_BUSINESS_GROUP_ID
...
,(SELECT Country.Name
	,DECODE(Country.ENABLED_FLAG, 'Y', 'Yes', 'No') CountryFlag
	,DECODE(Country.VIEW_ALL, 'Y', 'Yes', 'No') CountryVA
	,Country.CREATED_BY
	,Country.CREATION_DATE
	,Country.LAST_UPDATED_BY
	,Country.LAST_UPDATE_DATE
	,Country.BUSINESS_GROUP_ID
