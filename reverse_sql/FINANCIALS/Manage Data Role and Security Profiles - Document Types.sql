...
,DocTypeProfileEO.Name RES_NAME_BASIC_DETAILS
,DocTypeProfileEO.DOCUMENT_TYPE RES_DOCUMENT_TYPE
...
,DocTypeProfileEO.BUSINESS_GROUP_ID RSC_BUSINESS_GROUP_ID
...
,(SELECT DocType.Name
	...
	,DocProf.CREATED_BY
	,DocProf.CREATION_DATE
	,DocProf.LAST_UPDATED_BY
	,DocProf.LAST_UPDATE_DATE
	,DocProf.BUSINESS_GROUP_ID
	,DataE0.GENERATED_DATA_ROLE_ID
	FROM PER_DOC_TYPE_SECURITY_PROFILES DocType
	,PER_DOC_TYPE_SEC_PROF_DOCTYPES DocProf
	,PER_GEN_DATA_ROLE_PROFILES DataE0
	,HR_DOCUMENT_TYPES_VL DocTypeName
	WHERE DataE0.SECURITY_PROFILE_ID        = DocType.DOC_TYPE_SECURITY_PROFILE_ID
	AND DocType.DOC_TYPE_SECURITY_PROFILE_ID = DocProf.DOC_TYPE_SECURITY_PROFILE_ID
	AND DocProf.DOCUMENT_TYPE_ID = DocTypeName.DOCUMENT_TYPE_ID
