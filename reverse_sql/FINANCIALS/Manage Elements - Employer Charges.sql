 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Elements%20-%20Employer%20Charges.sql $:
 * $Id: Manage Elements - Employer Charges.sql 78239 2022-04-07 15:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
,(SELECT lk.MEANING
	...
	AND lk.LOOKUP_TYPE = 'ORA_PAY_TMPLT_DEDN_ZEROEARN'
	AND lk.LOOKUP_CODE = inp.DEFAULT_VALUE
	AND inp.NAME = 'Process Zero Earnings'
	AND inp.ELEMENT_TYPE_ID = elementsFE0.ELEMENT_TYPE_ID 
	) RES_HOW_DO_YOU_WANT_THE_ELEMEN	-- How do you want the element to be processed when an employee has zero earnings?
...
AND prClassesE0.CLASSIFICATION_NAME = 'Employer Charges'
