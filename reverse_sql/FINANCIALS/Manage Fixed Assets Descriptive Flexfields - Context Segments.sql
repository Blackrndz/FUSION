...
* $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Fixed%20Assets%20Descriptive%20Flexfields%20-%20Context%20Segments.sql $:
* $Id: Manage Fixed Assets Descriptive Flexfields - Context Segments.sql 78284 2022-04-13 06:03:20Z pisan.jariyasettachok $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
,NVL(
	...
	),decode(ContextSegment.READ_ONLY_FLAG,'N','No','')) AS RES_READ_ONLY
...
WHERE ContextSegment.APPLICATION_ID = 140
