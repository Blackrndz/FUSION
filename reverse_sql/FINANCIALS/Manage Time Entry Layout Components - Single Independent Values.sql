...
,(CASE
	WHEN ds.IMPLEMENTATION_TYPE = 'VIEW_OBJECT' THEN
		(CASE
			...
			WHEN ds.EXECUTABLE_CODE = 'oracle.apps.hcm.locUS.payrollSetup.details.publicView.UsStatePVO' THEN
...
AND layoutCompsE0.TCLAYFLD_ATTRIBUTE_NUMBER2 = ds.DATA_SOURCE_USAGE_ID(+)
