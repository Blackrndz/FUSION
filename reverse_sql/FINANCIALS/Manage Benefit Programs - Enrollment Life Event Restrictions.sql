...
,TO_CHAR(benLERCHAGPGME0.EFFECTIVE_START_DATE,'DD-Mon-YYYY') RES_RESTRICTIONS_EFFECTIVE_STA
,DECODE(TO_CHAR(benLERCHAGPGME0.EFFECTIVE_END_DATE ,'DD-MM-YYYY'),'31-12-4712',NULL,TO_CHAR(benLERCHAGPGME0.EFFECTIVE_END_DATE ,'DD-Mon-YYYY')) RES_RESTRICTIONS_EFFECTIVE_END
,(SELECT MEANING
