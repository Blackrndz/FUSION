...
* $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Legal%20Entity%20Configurator%20Descriptive%20Flexfield%20-%20Global%20Segments.sql $:
* $Id: Manage Legal Entity Configurator Descriptive Flexfield - Global Segments.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
,NVL(
	...
	),decode( GlobalSegment.ENABLED_FLAG,'N','No','')) AS RES_ENABLED
...
AND GlobalSegment.APPLICATION_ID = 204
