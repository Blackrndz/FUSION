...
, (SELECT MEANING FROM FND_LOOKUP_VALUES WHERE LOOKUP_CODE = Head.GEO_HIERARCHY_NODE_VALUE 
	AND LOOKUP_TYPE = 'ORA_PER_GEOGRAPHIC_TREE_NODES' AND LANGUAGE = USERENV('LANG')
	AND SYSDATE BETWEEN START_DATE_ACTIVE AND NVL(END_DATE_ACTIVE,TO_DATE('4712-12-31','YYYY-MM-DD'))) RES_GEOGRAPHIC_HIERARCHY
...
FROM
	...
	, LocationDetailDEO.GEO_HIERARCHY_NODE_VALUE
	, AddressDPEO.COUNTRY
