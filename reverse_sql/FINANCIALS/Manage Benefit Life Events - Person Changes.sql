...
,(SELECT FORMULA_NAME
			FROM FF_FORMULAS_TL
			WHERE LANGUAGE = USERENV('LANG')
			AND FORMULA_ID = persE0.PER_INFO_CHG_CS_LER_RL) RES_PERSON_CHANGE_FORMULA
,perChangesE0.LAST_UPDATED_BY RSC_LAST_UPDATED_BY
,perChangesE0.LAST_UPDATE_DATE RSC_LAST_UPDATE_DATE
,perChangesE0.CREATED_BY RSC_CREATED_BY
,perChangesE0.CREATION_DATE RSC_CREATION_DATE
,NULL RSC_LEDGER_ID
...
,BEN_LER_PER_INFO_CS_LER perChangesE0
,BEN_PER_INFO_CHG_CS_LER persE0
WHERE lifeEventsE0.LER_ID = perChangesE0.LER_ID
AND perChangesE0.PER_INFO_CHG_CS_LER_ID = persE0.PER_INFO_CHG_CS_LER_ID
