...
, remitToLocs.location_id                                                         AS RES_SITE_NUMBER
 ...
 loc.province AS RES_PROVINCE,
 loc.city AS RES_PREFECTURE,
 loc.ADDR_ELEMENT_ATTRIBUTE2 AS RES_COUNTY_OR_DISTRICT,
 loc.address1 AS RES_STREET_ADDRESS,
 loc.address2 AS RES_ADDITIONAL_ADDRESS_LINE
