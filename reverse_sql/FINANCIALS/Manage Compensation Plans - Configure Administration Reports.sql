...
,actionsE0.DESCRIPTION RES_DESCRIPTION
...
,(SELECT * 
	...
	WHERE KEY_TYPE = 'PLAN'
	AND ATTRIBUTE_NAME IN (SELECT LOOKUP_CODE FROM FND_LOOKUP_VALUES WHERE LANGUAGE = USERENV('LANG') AND LOOKUP_TYPE = 'CMP_CWB_ADMIN_REPORTS_MASTER')
	) actionsE0
