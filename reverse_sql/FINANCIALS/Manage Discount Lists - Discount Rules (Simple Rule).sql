...
,(SELECT MEANING
	...
	AND LOOKUP_CODE = QpPricingTermsVl.ADJUSTMENT_TYPE_CODE
	) RES_ADJUSTMENT_TYPE
,(CASE
	WHEN QpPricingTermsVl.ADJUSTMENT_TYPE_CODE = 'DISCOUNT_PERCENT' OR QpPricingTermsVl.ADJUSTMENT_TYPE_CODE = 'MARKUP_PERCENT' THEN
		'Adjustment basis'
	END) RES_ADJUSTMENT_BASIS
,QpPricingTermsVl.ADJUSTMENT_AMOUNT RES_ADJUSTMENT_AMOUNT
