...
WITH TMPpjsPERFTHRESEO AS 
	(SELECT THRES_OBJ_ID,FROM_VALUE,INDICATOR_CODE,LAST_UPDATED_BY
...
SELECT pjsPERFRULEEO.RULE_NAME RES_KPI_NAME
,(SELECT FROM_VALUE FROM TMPpjsPERFTHRESEO WHERE THRES_OBJ_ID = pjsPERFRULEEO.RULE_ID AND ROW_NUM = 2) RES_THRESHOLD
