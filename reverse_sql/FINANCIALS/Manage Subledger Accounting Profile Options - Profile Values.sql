 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Subledger%20Accounting%20Profile%20Options%20-%20Profile%20Values.sql $:
 * $Id: Manage Subledger Accounting Profile Options - Profile Values.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
AND ProfileOptionEO.MODULE_ID IN (SELECT rf.child_module_id
