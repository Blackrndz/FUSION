...
,'Manufacturing plant' RES_SECURITY_CONTEXT
,(SELECT ORGANIZATION_CODE
	FROM INV_ORG_PARAMETERS
	WHERE ORGANIZATION_ID = UserRoleE0.MFG_ORGANIZATION_ID
...
,UserRoleE0.MFG_ORGANIZATION_ID RSC_ORGANIZATION_ID
...
AND UserRoleE0.MFG_ORGANIZATION_ID IS NOT NULL
