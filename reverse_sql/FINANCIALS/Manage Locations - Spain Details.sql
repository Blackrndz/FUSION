...
* $Id: Manage Locations - Spain Details.sql 80146 2023-02-10 10:05:41Z tanawat.wongjan $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
AND((HEAD.EFFECTIVE_START_DATE = ES_PRL_NO.EFFECTIVE_START_DATE(+))
AND(HEAD.EFFECTIVE_END_DATE = ES_PRL_NO.EFFECTIVE_END_DATE(+))))
AND((HEAD.location_id = ES_PRL_YES.location_id(+))
AND((HEAD.EFFECTIVE_START_DATE = ES_PRL_YES.EFFECTIVE_START_DATE(+))
AND(HEAD.EFFECTIVE_END_DATE = ES_PRL_YES.EFFECTIVE_END_DATE(+))))
AND((HEAD.location_id = ES_RENTED_LOCATION.location_id(+))
AND((HEAD.EFFECTIVE_START_DATE = ES_RENTED_LOCATION.EFFECTIVE_START_DATE(+))
AND(HEAD.EFFECTIVE_END_DATE = ES_RENTED_LOCATION.EFFECTIVE_END_DATE(+))))
...
AND((HEAD.EFFECTIVE_START_DATE = ES_PROPERTY_LOCATION.EFFECTIVE_START_DATE(+))
AND(HEAD.EFFECTIVE_END_DATE = ES_PROPERTY_LOCATION.EFFECTIVE_END_DATE(+))))
