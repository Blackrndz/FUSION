 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Elements%20-%20Employer%20Liabilities.sql $:
 * $Id: Manage Elements - Employer Liabilities.sql 78239 2022-04-07 15:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
,(SELECT lk.MEANING
	...
	AND lk.LOOKUP_CODE = inp.DEFAULT_VALUE
	AND inp.NAME = 'GST'
	AND inp.ELEMENT_TYPE_ID = elementsFE0.ELEMENT_TYPE_ID) RES_DOES_GST_APPLY
,(SELECT lk.MEANING
	FROM PAY_INPUT_VALUES_VL inp
	,FND_LOOKUP_VALUES lk
	WHERE lk.LANGUAGE = USERENV('LANG')
	...
	AND lk.LOOKUP_CODE = inp.DEFAULT_VALUE
	AND inp.NAME = 'HST'
	AND inp.ELEMENT_TYPE_ID = elementsFE0.ELEMENT_TYPE_ID) RES_DOES_HST_APPLY
,(SELECT lk.MEANING
	FROM PAY_INPUT_VALUES_VL inp
	,FND_LOOKUP_VALUES lk
	WHERE lk.LANGUAGE = USERENV('LANG')
	...
	AND lk.LOOKUP_CODE = inp.DEFAULT_VALUE
	AND inp.NAME = 'PPT'
	AND inp.ELEMENT_TYPE_ID = elementsFE0.ELEMENT_TYPE_ID) RES_DOES_PPT_APPLY
,(SELECT lk.MEANING
	FROM PAY_INPUT_VALUES_VL inp
	,FND_LOOKUP_VALUES lk
	WHERE lk.LANGUAGE = USERENV('LANG')
	...
	AND lk.LOOKUP_CODE = inp.DEFAULT_VALUE
	AND inp.NAME = 'PST'
	AND inp.ELEMENT_TYPE_ID = elementsFE0.ELEMENT_TYPE_ID) RES_DOES_PST_APPLY
,(SELECT lk.MEANING
	FROM PAY_INPUT_VALUES_VL inp
	,FND_LOOKUP_VALUES lk
	WHERE lk.LANGUAGE = USERENV('LANG')
	...
	AND lk.LOOKUP_CODE = inp.DEFAULT_VALUE
	AND inp.NAME = 'RST'
	AND inp.ELEMENT_TYPE_ID = elementsFE0.ELEMENT_TYPE_ID) RES_DOES_RST_APPLY
,(SELECT lk.MEANING
	FROM PAY_INPUT_VALUES_VL inp
	,FND_LOOKUP_VALUES lk
	WHERE lk.LANGUAGE = USERENV('LANG')
	...
	AND inp.ELEMENT_TYPE_ID = elementsFE0.ELEMENT_TYPE_ID) RES_SHOULD_THE_TAX_BE_REPORTED
...
AND prClassesE0.CLASSIFICATION_NAME = 'Employer Liabilities'
