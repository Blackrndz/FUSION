...
,payElementlinkE0.ELEMENT_LINK_NAME RES_COSTING_BY_ASSIGNMENT_ATTR
,(SELECT MEANING
...
,(SELECT PAYROLL_NAME 
	...
	WHERE PAYROLL_ID = payElementcriE0.PAYROLL_ID
...
AND NVL(elementsE0.EFFECTIVE_END_DATE,TO_DATE('4712-12-31','YYYY-MM-DD')) BETWEEN payElementlinkE0.EFFECTIVE_START_DATE AND NVL(payElementlinkE0.EFFECTIVE_END_DATE,TO_DATE('4712-12-31','YYYY-MM-DD'))
AND NVL(payElementlinkE0.COSTING_LINK_FLAG,'N') = 'Y'
