 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Remit%20to%20Addresses%20(Belgium)%20-%20Manage%20Remit%20to%20Addresses.sql $:
 * $Id: Manage Remit to Addresses (Belgium) - Manage Remit to Addresses.sql 79966 2023-01-12 08:58:08Z tanawat.wongjan $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
, remitToLocs.location_id                                                         AS RES_SITE_NUMBER
 ...
 loc.address1 RES_STREET_NAME,
 loc.address2 RES_HOUSE_NUMBER,
 loc.address3 RES_HOUSE_NUMBER_ADDITION,
