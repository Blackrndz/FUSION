...
,(SELECT MEANING
	...
	AND LOOKUP_CODE = InfoEO.ORG_INFORMATION2 
	) RES_BARGAINING_UNIT
,(SELECT LOCATION_NAME 
	FROM PER_LOCATION_DETAILS_F_VL
	WHERE SYSDATE BETWEEN EFFECTIVE_START_DATE AND EFFECTIVE_END_DATE
	AND LOCATION_ID = InfoEO.ORG_INFORMATION_NUMBER1 
	) RES_LOCATION
,InfoEO.ORG_INFORMATION3 RES_CONTACT_NAME
,InfoEO.ORG_INFORMATION4 RES_CONTACT_TITLE
,InfoEO.ORG_INFORMATION5 RES_WORK_PHONE
,InfoEO.ORG_INFORMATION6 RES_WORK_EMAIL
...
,(SELECT ORGANIZATION_ID
	...
	WHERE 
	--SYSDATE BETWEEN EFFECTIVE_START_DATE AND EFFECTIVE_END_DATE AND 
	ORG_INFORMATION_CONTEXT = 'ORA_PER_UNION_ASSOCIATED_BARGAINING_UNITS'
	) InfoEO
WHERE workerUnionsE0.ORGANIZATION_ID = InfoEO.ORGANIZATION_ID 
AND workerUnionsE0.EFFECTIVE_START_DATE BETWEEN InfoEO.EFFECTIVE_START_DATE AND InfoEO.EFFECTIVE_END_DATE
