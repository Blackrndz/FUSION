 ...
 * $HeadURL: http://svn01.rapidesuite.com:999/svn/a/dev/rapidesuite/controldata/FUSION_11.1.12/trunk/core/reverse_sql/FINANCIALS/Manage%20Chart%20of%20Accounts%20Structures%20-%20Manage%20Key%20Flexfield%20Structures.sql $:
 * $Id: Manage Chart of Accounts Structures - Manage Key Flexfield Structures.sql 63862 2017-09-15 03:07:01Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
AND Detail.STRUCTURE_ID = StructureInstance.STRUCTURE_ID(+)
