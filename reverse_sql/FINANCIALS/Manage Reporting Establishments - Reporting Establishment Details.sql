...
SELECT (
	CASE
		WHEN EXISTS
			...
			WHERE OrgUnitClassificationDEO2.CLASSIFICATION_CODE != 'HCM_REPORTING_ESTABLISHMENT'
			...
			AND EXISTS
				...
				WHERE OrgUnitClassificationDEO3.CLASSIFICATION_CODE = 'HCM_REPORTING_ESTABLISHMENT'
...
,InfoEO.ORG_INFORMATION1 RES_REPORTING_NAME
,(SELECT FULL_NAME
	FROM PER_PERSON_NAMES_F
	WHERE NAME_TYPE = 'GLOBAL'
	AND SYSDATE BETWEEN EFFECTIVE_START_DATE AND EFFECTIVE_END_DATE
	AND PERSON_ID = InfoEO.ORG_INFORMATION2
	) RES_MANAGER
