 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Positions%20-%20Position%20Details.sql $:
 * $Id: Manage Positions - Position Details.sql 80480 2023-03-17 11:25:41Z tanawat.wongjan $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
,(SELECT NAME
	FROM IRC_REQUISITIONS_TL
	WHERE LANGUAGE = USERENV('LANG')
	AND REQUISITION_ID = positionsE0.REQUISITION_TEMPLATE_ID 
	) RES_REQUISITION_TEMPLATE
,(SELECT NAME
	FROM HR_ALL_POSITIONS_F_VL 
	WHERE POSITION_ID = positionsE0.DELEGATE_POSITION_ID
	AND SYSDATE BETWEEN EFFECTIVE_START_DATE AND NVL(EFFECTIVE_END_DATE ,TO_DATE('31-12-4712','DD-MM-YYYY'))
	) RES_DELEGATE_POSITION
