 ...
 * $Date: 2018-03-21  $:
 * $HeadURL: $:
 * $Id: Configure Exception Sets - Filter Categories $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
,(SELECT CATEGORY_NAME
	FROM MSC_CATALOG_CATEGORIES
	WHERE CATEGORY_ID = ExceptionSetFiltersE0.FILTER_VALUE
	) RES_CATEGORY
...
AND ExceptionSetFiltersE0.FILTER_TYPE = 2
ORDER BY 1,2