 ...
 * $Date: 2022-12-13 12:58:50 +0700 (Tue, 13 Dec 2022) $:
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Duties%20-%20Role%20Data%20Security%20Policies.sql $:
 * $Id: Manage Duties - Role Data Security Policies.sql 79816 2022-12-13 05:58:50Z tanawat.wongjan $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
WITH DATASEC AS (SELECT /*+ PARALLEL(8) */ ACTION_ID
	...
	,END_DATE
	,DESCRIPTION
	,ROW_NUMBER() OVER(PARTITION BY ROLE_CODE,POLICY_NAME,DB_RESOURCE ORDER BY ACTION_ID DESC) R1
