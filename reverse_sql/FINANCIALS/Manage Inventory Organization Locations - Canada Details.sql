...
AND((HEAD.EFFECTIVE_START_DATE BETWEEN Census.EFFECTIVE_START_DATE(+) AND Census.EFFECTIVE_END_DATE(+))
AND(HEAD.EFFECTIVE_END_DATE BETWEEN Census.EFFECTIVE_START_DATE(+) AND Census.EFFECTIVE_END_DATE(+))))
