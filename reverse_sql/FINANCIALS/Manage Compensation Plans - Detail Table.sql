...
,(SELECT MEANING FROM FND_LOOKUP_VALUES WHERE LOOKUP_CODE = cmpCSTME0.REGION_NAME 
			AND LOOKUP_TYPE = 'CMP_BUDGET_DTL_MCOLS' AND LANGUAGE = USERENV('LANG')
			AND SYSDATE BETWEEN START_DATE_ACTIVE AND NVL(END_DATE_ACTIVE,TO_DATE('4712-12-31','YYYY-MM-DD'))) RES_PARENT_COLUMN
,DECODE(cmpCSTME0.ITEM_NAME,'AllocationUsed','Allocated', 'AccessCd','Budget Access Level', 'Currency','Currency', 'DistWsBudgetVal','Distributed Amount', 'IssBdgtAmt','Distributed Amount', 'IssBdgtPct','Distributed Percentage'
, 'DistBudgetValPct','Distributed Percentage', 'EligSalVal','Eligible Salary', 'EligCountAll','Eligible Workers', 'GroupView','Group View', 'InEligEmployees','Ineligible Workers', 'JobName','Job', 'IssDate','Last Publish Date'
, 'TopManagerName','Manager', 'TopManagerName','Manager cc', 'Misc1Val','Miscellaneous Rate 1', 'Misc2Val','Miscellaneous Rate 2', 'Misc3Val','Miscellaneous Rate 3', 'Misc4Val','Miscellaneous Rate 4', 'Misc5Val'
,'Miscellaneous Rate 5', 'Misc6Val','Miscellaneous Rate 6', 'WorkerNumber','Person Number', 'AllocationUnused','Remaining Budget', 'RecVal','Target Allocation', 'RecMxVal','Target Compensation Amount Maximum'
, 'RecMnVal','Target Compensation Amount Minimum', 'RecValPct','Target Compensation Percentage', 'RecMxValPct','Target Compensation Percentage Maximum', 'RecMnValPct','Target Compensation Percentage Minimum'
, 'Uom','Units', 'NonIssBdgtAmt','Unpublished', 'EmpList','Worker List') RES_COLUMN
...
AND cmpCSTME0.REGION_NAME LIKE 'DETAIL_TABLE%MCOL'
