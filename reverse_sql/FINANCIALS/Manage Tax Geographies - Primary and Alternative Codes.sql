...
,identifiersE0.IDENTIFIER_VALUE RES_CODE
,(SELECT MEANING
	FROM FND_LOOKUP_VALUES
	WHERE LANGUAGE = USERENV('LANG')
	AND LOOKUP_TYPE = 'HZ_GEO_IDENTIFIER_SUBTYPE'
	AND LOOKUP_CODE = identifiersE0.IDENTIFIER_SUBTYPE 
	) RES_CODE_TYPE
,(SELECT MEANING
	FROM FND_LOOKUP_VALUES
	WHERE LANGUAGE = USERENV('LANG')
...
AND identifiersE0.IDENTIFIER_TYPE = 'CODE'
