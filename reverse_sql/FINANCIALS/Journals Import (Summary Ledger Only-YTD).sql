 ...
 * $Date: 2018-06-20  $:
 * $HeadURL: $:
 * $Id: $: Journals Import (Summary Ledger Only-YTD)
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
,(Case 
	when (PERIOD_NET_DR + BEGIN_BALANCE_DR) - (PERIOD_NET_CR + BEGIN_BALANCE_CR) > 0 then
		/*(CASE
			WHEN INSTR(TO_CHAR(ROUND((PERIOD_NET_DR + BEGIN_BALANCE_DR) - (PERIOD_NET_CR + BEGIN_BALANCE_CR),2)),'.',1,1) = 0 THEN 
				TO_CHAR(ROUND((PERIOD_NET_DR + BEGIN_BALANCE_DR) - (PERIOD_NET_CR + BEGIN_BALANCE_CR),2))||'.00'
			WHEN LENGTH(SUBSTR(TO_CHAR(ROUND((PERIOD_NET_DR + BEGIN_BALANCE_DR) - (PERIOD_NET_CR + BEGIN_BALANCE_CR),2))	,INSTR(TO_CHAR(ROUND((PERIOD_NET_DR + BEGIN_BALANCE_DR) - (PERIOD_NET_CR + BEGIN_BALANCE_CR),2)),'.',1,1)+1	,LENGTH(TO_CHAR(ROUND((PERIOD_NET_DR + BEGIN_BALANCE_DR) - (PERIOD_NET_CR + BEGIN_BALANCE_CR),2) ) ) ) ) = 2 THEN
				TO_CHAR(ROUND((PERIOD_NET_DR + BEGIN_BALANCE_DR) - (PERIOD_NET_CR + BEGIN_BALANCE_CR),2))
			WHEN LENGTH(SUBSTR(TO_CHAR(ROUND((PERIOD_NET_DR + BEGIN_BALANCE_DR) - (PERIOD_NET_CR + BEGIN_BALANCE_CR),2)),INSTR(TO_CHAR(ROUND((PERIOD_NET_DR + BEGIN_BALANCE_DR) - (PERIOD_NET_CR + BEGIN_BALANCE_CR),2)),'.',1,1)+1,LENGTH(TO_CHAR(ROUND((PERIOD_NET_DR + BEGIN_BALANCE_DR) - (PERIOD_NET_CR + BEGIN_BALANCE_CR),2))))) = 1 THEN
				(CASE
					WHEN ROUND((PERIOD_NET_DR + BEGIN_BALANCE_DR) - (PERIOD_NET_CR + BEGIN_BALANCE_CR),2) = 0 THEN '0.00'
					ELSE TO_CHAR(ROUND((PERIOD_NET_DR + BEGIN_BALANCE_DR) - (PERIOD_NET_CR + BEGIN_BALANCE_CR),2))||'0'
				END)
			WHEN TO_CHAR(ROUND((PERIOD_NET_DR + BEGIN_BALANCE_DR) - (PERIOD_NET_CR + BEGIN_BALANCE_CR),2)) IS NULL THEN
				NULL
			ELSE
				TO_CHAR(ROUND((PERIOD_NET_DR + BEGIN_BALANCE_DR) - (PERIOD_NET_CR + BEGIN_BALANCE_CR),2))||'.00'
			END)*/
		TO_CHAR((PERIOD_NET_DR + BEGIN_BALANCE_DR) - (PERIOD_NET_CR + BEGIN_BALANCE_CR))
	else
		'0.00'
...
,(Case 
	when (PERIOD_NET_DR + BEGIN_BALANCE_DR) - (PERIOD_NET_CR + BEGIN_BALANCE_CR) < 0 then
		/*(CASE
			WHEN INSTR(TO_CHAR(ROUND(((PERIOD_NET_DR + BEGIN_BALANCE_DR) - (PERIOD_NET_CR + BEGIN_BALANCE_CR)) * -1,2)),'.',1,1) = 0 THEN 
				TO_CHAR(ROUND(((PERIOD_NET_DR + BEGIN_BALANCE_DR) - (PERIOD_NET_CR + BEGIN_BALANCE_CR)) * -1,2))||'.00'
			WHEN LENGTH(SUBSTR(TO_CHAR(ROUND(((PERIOD_NET_DR + BEGIN_BALANCE_DR) - (PERIOD_NET_CR + BEGIN_BALANCE_CR)) * -1,2))	,INSTR(TO_CHAR(ROUND(((PERIOD_NET_DR + BEGIN_BALANCE_DR) - (PERIOD_NET_CR + BEGIN_BALANCE_CR)) * -1,2)),'.',1,1)+1	,LENGTH(TO_CHAR(ROUND(((PERIOD_NET_DR + BEGIN_BALANCE_DR) - (PERIOD_NET_CR + BEGIN_BALANCE_CR)) * -1,2) ) ) ) ) = 2 THEN
				TO_CHAR(ROUND(((PERIOD_NET_DR + BEGIN_BALANCE_DR) - (PERIOD_NET_CR + BEGIN_BALANCE_CR)) * -1,2))
			WHEN LENGTH(SUBSTR(TO_CHAR(ROUND(((PERIOD_NET_DR + BEGIN_BALANCE_DR) - (PERIOD_NET_CR + BEGIN_BALANCE_CR)) * -1,2)),INSTR(TO_CHAR(ROUND(((PERIOD_NET_DR + BEGIN_BALANCE_DR) - (PERIOD_NET_CR + BEGIN_BALANCE_CR)) * -1,2)),'.',1,1)+1,LENGTH(TO_CHAR(ROUND(((PERIOD_NET_DR + BEGIN_BALANCE_DR) - (PERIOD_NET_CR + BEGIN_BALANCE_CR)) * -1,2))))) = 1 THEN
				(CASE
					WHEN ROUND(((PERIOD_NET_DR + BEGIN_BALANCE_DR) - (PERIOD_NET_CR + BEGIN_BALANCE_CR)) * -1,2) = 0 THEN '0.00'
					ELSE TO_CHAR(ROUND(((PERIOD_NET_DR + BEGIN_BALANCE_DR) - (PERIOD_NET_CR + BEGIN_BALANCE_CR)) * -1,2))||'0'
				END)
			WHEN TO_CHAR(ROUND(((PERIOD_NET_DR + BEGIN_BALANCE_DR) - (PERIOD_NET_CR + BEGIN_BALANCE_CR)) * -1,2)) IS NULL THEN
				NULL
			ELSE
				TO_CHAR(ROUND(((PERIOD_NET_DR + BEGIN_BALANCE_DR) - (PERIOD_NET_CR + BEGIN_BALANCE_CR)) * -1,2))||'.00'
			END)*/
		TO_CHAR(((PERIOD_NET_DR + BEGIN_BALANCE_DR) - (PERIOD_NET_CR + BEGIN_BALANCE_CR)) * -1)
	else
		'0.00'
...
and ((BA.PERIOD_NET_DR <> BA.PERIOD_NET_CR) OR (BA.BEGIN_BALANCE_DR <> BA.BEGIN_BALANCE_CR))

and BA.LEDGER_ID IN ( SELECT AA.LEDGER_ID FROM GL_LEDGERS  AA
                           where NOT exists (select SET_OF_BOOKS_ID  
                                            FROM hr_operating_units hou 
                                            where AA.LEDGER_ID = hou.SET_OF_BOOKS_ID)
                           )