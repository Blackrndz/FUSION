 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Assign%20Balancing%20Segment%20Values%20to%20Legal%20Entities%20(Primary%20Ledger)%20-%20Assign%20Balancing%20Segment%20Values%20t $:
 * $Id: Assign Balancing Segment Values to Legal Entities (Primary Ledger) - Assign Balancing Segment Values to Legal Entities.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */


select DISTINCT QRSLT.PRIMARY_LEDGER RES_PRIMARY_LEDGER,
...
from 
(SELECT
  GlLegalEntitiesBsvs.LEGAL_ENTITY_ID,
...
order by RES_PRIMARY_LEDGER,RES_VALUE_SET,RES_LEGAL_ENTITY,RES_COMPANY_VALUE