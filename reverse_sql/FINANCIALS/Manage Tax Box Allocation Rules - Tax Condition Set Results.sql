...
,ZxProcessResultsDetail.ALPHANUMERIC_VALUE RES_TAX_BOX_NUMBER
...
,ZX_PROCESS_RESULT_DETAILS ZxProcessResultsDetail
...
AND ZxProcessResults.RESULT_ID = ZxProcessResultsDetail.RESULT_ID
AND ZxRulesVl.DET_FACTOR_TEMPL_CODE = detFactorsE0.DET_FACTOR_TEMPL_CODE
ORDER BY ZxRulesVl.TAX_RULE_CODE
,ZxProcessResultsDetail.ALPHANUMERIC_VALUE