 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Reporting%20Currencies%20(Secondary%20Ledger)%20-%20Journal%20Conversion%20Rules.sql $:
 * $Id: Manage Reporting Currencies (Secondary Ledger) - Journal Conversion Rules.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
,(SELECT NAME
	FROM GL_LEDGERS
	WHERE LEDGER_ID = GlLedgerRelationships.SLA_LEDGER_ID
	) AS RES_SECONDARY_LEDGER
...
AND GlLedgerRelationships.SLA_LEDGER_ID              IN
	(SELECT LEDGER_ID
	FROM GL_LEDGERS
