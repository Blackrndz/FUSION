...
,benELIGOTHRPTIPEO.ORDR_NUM RES_SEQUENCE
...
,(SELECT NAME
	...
	AND PL_TYP_ID = benPTIPEO.PL_TYP_ID
	) RES_PLAN_TYPE_NAME
,(SELECT NAME
	FROM BEN_PGM_F
	WHERE SYSDATE BETWEEN EFFECTIVE_START_DATE AND NVL(EFFECTIVE_END_DATE,TO_DATE('4712-12-31','YYYY-MM-DD'))
	AND PGM_ID = benPTIPEO.PGM_ID
	) RES_PROGRAM_NAME
,DECODE(benELIGOTHRPTIPEO.EXCLD_FLAG,'Y','Yes','No') RES_EXCLUDE
,TO_CHAR(benELIGOTHRPTIPEO.START_DATE,'DD-Mon-YYYY') RES_START_DATE
,TO_CHAR(benELIGOTHRPTIPEO.END_DATE,'DD-Mon-YYYY') RES_END_DATE
,benELIGOTHRPTIPEO.LAST_UPDATED_BY  RSC_LAST_UPDATED_BY
,benELIGOTHRPTIPEO.LAST_UPDATE_DATE  RSC_LAST_UPDATE_DATE
,benELIGOTHRPTIPEO.CREATED_BY  RSC_CREATED_BY
,benELIGOTHRPTIPEO.CREATION_DATE  RSC_CREATION_DATE
,NULL RSC_LEDGER_ID
...
,BEN_ELIG_OTHR_PTIP_PRTE benELIGOTHRPTIPEO
...
AND benELIGYEO.ELIGY_PRFL_ID = benELIGOTHRPTIPEO.ELIGY_PRFL_ID 
AND benELIGYEO.END_DATE BETWEEN benELIGOTHRPTIPEO.START_DATE AND NVL(benELIGOTHRPTIPEO.END_DATE,TO_DATE('4712-12-31','YYYY-MM-DD'))
AND benELIGOTHRPTIPEO.PTIP_ID = benPTIPEO.PTIP_ID
AND benELIGOTHRPTIPEO.END_DATE BETWEEN benPTIPEO.EFFECTIVE_START_DATE AND NVL(benPTIPEO.EFFECTIVE_END_DATE,TO_DATE('4712-12-31','YYYY-MM-DD'))
ORDER BY benELIGYEO.NAME
,benELIGOTHRPTIPEO.ORDR_NUM