...
* $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Environment%20Health%20and%20Safety%20Descriptive%20Flexfields%20-%20Context%20Segments.sql $:
* $Id: Manage Environment Health and Safety Descriptive Flexfields - Context Segments.sql 78284 2022-04-13 06:03:20Z pisan.jariyasettachok $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
,ContextSegment.CREATED_BY  AS RSC_CREATED_BY
,ContextSegment.CREATION_DATE AS RSC_CREATION_DATE
...
WHERE ContextSegment.APPLICATION_ID = 800
