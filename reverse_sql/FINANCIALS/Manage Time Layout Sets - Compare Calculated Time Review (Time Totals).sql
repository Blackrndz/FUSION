...
,(SELECT * FROM HXT_TCLAYFLD_DEFNS_VL WHERE TCLAYFLD_ATTRIBUTE_CATEGORY IN 'HOURS_CATEGORIES_TCR_CCTT') hourE0
,(SELECT * FROM HXT_TCLAYFLD_DEFNS_VL WHERE TCLAYFLD_ATTRIBUTE_CATEGORY IN 'DAYS_CATEGORIES_TCR_CCTT') daycateE0
