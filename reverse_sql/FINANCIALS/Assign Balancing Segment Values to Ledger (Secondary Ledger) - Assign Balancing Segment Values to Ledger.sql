 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Assign%20Balancing%20Segment%20Values%20to%20Ledger%20(Secondary%20Ledger)%20-%20Assign%20Balancing%20Segment%20Values%20to%20Ledg $:
 * $Id: Assign Balancing Segment Values to Ledger (Secondary Ledger) - Assign Balancing Segment Values to Ledger.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */


select PRI.name  RES_PRIMARY_LEDGER
,QRSLT.NAME1   RES_SECONDARY_LEDGER
...
,(select distinct	GLLEDGERCONFIGDETAILS.CONFIGURATION_ID
	  ,GlLedgers.NAME	
	FROM GL_LEDGER_CONFIG_DETAILS GlLedgerConfigDetails
	,GL_LEDGERS GlLedgers
	,XLE_ENTITY_PROFILES XleEntityProfiles
	WHERE GlLedgerConfigDetails.CONFIGURATION_ID = GlLedgers.CONFIGURATION_ID
	...
	and XLEENTITYPROFILES.LEGAL_ENTITY_ID        = GLLEDGERCONFIGDETAILS.OBJECT_ID ) PRI
where 	QRSLT.CONFIGURATION_ID = PRI.CONFIGURATION_ID
ORDER BY PRI.name,QRSLT.NAME1,QRSLT.SEGMENT_VALUE