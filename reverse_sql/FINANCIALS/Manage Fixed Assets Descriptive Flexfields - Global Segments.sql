...
* $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Fixed%20Assets%20Descriptive%20Flexfields%20-%20Global%20Segments.sql $:
* $Id: Manage Fixed Assets Descriptive Flexfields - Global Segments.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
,decode(GlobalSegment.DEFAULT_TYPE,'','',GlobalSegment.DEFAULT_VALUE)    AS RES_DEFAULT_VALUE
...
,NVL(
	...
	),decode(GlobalSegment.READ_ONLY_FLAG,'N','No','')) AS RES_READ_ONLY
...
AND GlobalSegment.APPLICATION_ID = 140
