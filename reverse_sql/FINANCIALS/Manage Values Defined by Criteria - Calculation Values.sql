...
,tmpITEMEO.CALC_TYPE_ID AS ITEM_CALC_TYPE_ID
...
,RES_CALCULATION_VALUE_START_DA
,RES_CALCULATION_VALUE_END_DATE
,RES_CALCULATION_VALUE_FROM_VAL
,RES_CALCULATION_VALUE_TO_VALUE
,RES_CALCULATION_VALUE_CALCULAT
,RES_CALCULATION_VALUE_FLAT_AMO
,RES_CALCULATION_VALUE_RATE
,RES_CALCULATION_VALUE_CALCUL_1
,RES_CALCULATION_VALUE_NUMBER
,RES_CALCULATION_VALUE_RATE_DEF
,RES_CALCULATION_VALUE_PARAMETE
,RES_CALCULATION_VALUE_PARAME_2
,RES_CALCULATION_VALUE_PARAME_3
...
,TO_CHAR(tmpPAY.ITEM_START_DATE,'DD-Mon-YYYY') RES_CALCULATION_VALUE_START_DA
,TO_CHAR(tmpPAY.ITEM_END_DATE,'DD-Mon-YYYY') RES_CALCULATION_VALUE_END_DATE
,tmpPAY.LOW_VALUE RES_CALCULATION_VALUE_FROM_VAL
,tmpPAY.HIGH_VALUE RES_CALCULATION_VALUE_TO_VALUE
,calTYPEO.NAME RES_CALCULATION_VALUE_CALCULAT
,(CASE WHEN calTYPEO.NAME IN ('Flat Amount','Flat Amount Times Multiplier')
	THEN tmpPAY.VALUE1
	ELSE NULL END) RES_CALCULATION_VALUE_FLAT_AMO
,(CASE WHEN calTYPEO.NAME IN ('Flat Rate','Incremental Rate')
	THEN tmpPAY.VALUE1
	ELSE NULL END) RES_CALCULATION_VALUE_RATE
,(CASE WHEN calTYPEO.NAME IN ('Flat Calculation') 
	...
	ELSE NULL END) RES_CALCULATION_VALUE_CALCUL_1
,(CASE WHEN calTYPEO.NAME IN ('Number')
	THEN tmpPAY.VALUE1
	ELSE NULL END) RES_CALCULATION_VALUE_NUMBER
,(CASE WHEN calTYPEO.NAME IN ('Rate Definition')
	...
	ELSE NULL END) RES_CALCULATION_VALUE_RATE_DEF
,(CASE WHEN calTYPEO.NAME IN ('Standard Formula 1','Standard Formula 2')
	THEN tmpPAY.VALUE1
	ELSE NULL END) RES_CALCULATION_VALUE_PARAMETE
,(CASE WHEN calTYPEO.NAME IN ('Standard Formula 1','Standard Formula 2')
	THEN tmpPAY.VALUE2
	ELSE NULL END) RES_CALCULATION_VALUE_PARAME_2
,(CASE WHEN calTYPEO.NAME IN ('Standard Formula 1','Standard Formula 2')
	THEN tmpPAY.VALUE3
	ELSE NULL END) RES_CALCULATION_VALUE_PARAME_3
...
AND NVL(tmpPAY.ITEM_CALC_TYPE_ID,tmpPAY.CALC_TYPE_ID) = calTYPEO.CALC_TYPE_ID
AND tmpPAY.EFFECTIVE_START_DATE = TreeE0.EFFECTIVE_START_DATE
--AND (tmpPAY.EXPRESSION IS NULL OR tmpPAY.EXPRESSION <> 'IN')
ORDER BY RES_LEVEL,RES_PARENT_1,RES_CRITERIA_OR_VALUE_DISPLAYE,RES_CALCULATION_VALUE_FROM_VAL
)
