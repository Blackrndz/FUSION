 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Mapping%20Sets%20-%20Segment.sql $:
 * $Id: Manage Mapping Sets - Segment.sql 80185 2023-02-16 09:49:42Z tanawat.wongjan $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
,(SELECT SegmentE0.NAME 
	FROM FND_KF_SEGMENTS_VL SegmentE0
	WHERE KfStructIns.STRUCTURE_ID = SegmentE0.STRUCTURE_ID
	AND MappingSetFlavorEO.FLEXFIELD_SEGMENT_CODE = SegmentE0.COLUMN_NAME) RES_SEGMENT
,(CASE
