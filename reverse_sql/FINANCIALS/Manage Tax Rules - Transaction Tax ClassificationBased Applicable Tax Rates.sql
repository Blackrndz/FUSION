...
,CONDITION_GROUP_CODE RES_TAX_CLASSIFICATION_CODE
,(SELECT DISTINCT MEANING 
	FROM ZX_TAX_CLASSIFICATIONS_V
	WHERE LOOKUP_CODE = CONDITION_GROUP_CODE
	)RES_TAX_CLASSIFICATION_NAME
...
AND ZxRulesVl.SERVICE_TYPE_CODE           = 'DET_DIRECT_RATE_STCC'
