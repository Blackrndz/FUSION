...
,(SELECT NAME
	FROM QP_SHIPPING_CHARGE_LISTS_TL
	WHERE SHIPPING_CHARGE_LIST_ID = QpStrategyDetailE0.DETAIL_ENTITY_ID
	AND LANGUAGE        = USERENV('LANG')
	) RES_SHIPPING_CHARGE_LIST_NAME
...
AND QpStrategyDetailE0.DETAIL_ENTITY_TYPE_CODE = 'ORA_SHIPPING_CHARGE_LIST'
