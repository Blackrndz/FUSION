...
* $Id: Manage Locations - Japan Details.sql 80146 2023-02-10 10:05:41Z tanawat.wongjan $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
, HEAD.region_2 RES_PREFECTURE
, HEAD.town_or_city RES_CITY
, DECODE(NVL(AddressFormatE0.ADDRESS_STYLE_CODE,'POSTAL_ADDR'),'POSTAL_ADDR',HEAD.ADDL_ADDRESS_ATTRIBUTE2,NULL) RES_WARD
, HEAD.ADDRESS_LINE_1 RES_ADDRESS_LINE_1
, HEAD.address_line_2 RES_ADDRESS_LINE_2
, HEAD.address_line_3 RES_ADDRESS_LINE_3
, NULL RES_PHONETIC_ADDRESS
, DECODE(NVL(AddressFormatE0.ADDRESS_STYLE_CODE,'POSTAL_ADDR'),'SUPP_TAX_AND_RPTNG_ADDR',HEAD.ADDL_ADDRESS_ATTRIBUTE1,NULL) RES_ADDRESS_1_HALF_WIDTH_KANA
, DECODE(NVL(AddressFormatE0.ADDRESS_STYLE_CODE,'POSTAL_ADDR'),'SUPP_TAX_AND_RPTNG_ADDR',HEAD.ADDL_ADDRESS_ATTRIBUTE1,NULL) RES_ADDRESS_2_HALF_WIDTH_KANA
, DECODE(NVL(AddressFormatE0.ADDRESS_STYLE_CODE,'POSTAL_ADDR'),'SUPP_TAX_AND_RPTNG_ADDR',HEAD.ADDL_ADDRESS_ATTRIBUTE1,NULL) RES_ADDRESS_3_HALF_WIDTH_KANA
