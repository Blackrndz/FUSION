...
,DocName.NAME RES_DOCUMENT_SEQUENCE_NAME
,JgZzVatDocSequences.LAST_UPDATED_BY RSC_LAST_UPDATED_BY
,JgZzVatDocSequences.LAST_UPDATE_DATE RSC_LAST_UPDATE_DATE
,JgZzVatDocSequences.CREATED_BY RSC_CREATED_BY
,JgZzVatDocSequences.CREATION_DATE RSC_CREATION_DATE
,NULL RSC_LEDGER_ID
...
,JG_ZZ_VAT_DOC_SEQUENCES JgZzVatDocSequences
,JG_ZZ_VAT_REGISTERS_B VATRegister
,FND_DOCUMENT_SEQUENCES DocName
,HZ_PARTIES PartyPEO
...
AND VATRegister.VAT_REGISTER_ID                = JgZzVatDocSequences.VAT_REGISTER_ID
AND JgZzVatDocSequences.DOC_SEQUENCE_ID        = DocName.DOC_SEQUENCE_ID
