...
,(CASE 
	WHEN ZxReportingTypesVl.REPORTING_TYPE_DATATYPE_CODE = 'TEXT' THEN
		TaxReportingCodeAssociationE0.REPORTING_CODE_CHAR_VALUE
	WHEN ZxReportingTypesVl.REPORTING_TYPE_DATATYPE_CODE = 'DATE' THEN
		TO_CHAR(TaxReportingCodeAssociationE0.REPORTING_CODE_DATE_VALUE,'DD-Mon-YYYY')
	WHEN ZxReportingTypesVl.REPORTING_TYPE_DATATYPE_CODE = 'NUMERIC_VALUE' THEN
		TO_CHAR(TaxReportingCodeAssociationE0.REPORTING_CODE_NUM_VALUE)
	END
...
AND BusinessUnitTaxProfileEO.PARTY_TAX_PROFILE_ID = TaxReportingCodeAssociationE0.ENTITY_ID
