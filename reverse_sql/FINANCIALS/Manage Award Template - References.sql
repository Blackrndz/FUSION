...
,gmsAWARDREFE0.REFERENCE_VALUE RES_VALUE
,gmsREFE0.DESCRIPTION RES_DESCRIPTION 



,gmsAWARDREFE0.LAST_UPDATED_BY RSC_LAST_UPDATED_BY
,gmsAWARDREFE0.LAST_UPDATE_DATE RSC_LAST_UPDATE_DATE
,gmsAWARDREFE0.CREATED_BY RSC_CREATED_BY
,gmsAWARDREFE0.CREATION_DATE RSC_CREATION_DATE
,null RSC_LEDGER_ID
...
,GMS_AWARD_REFERENCES_VL gmsAWARDREFE0
,GMS_REFERENCES_VL gmsREFE0
WHERE gmsAWARDTEMPE0.AWARD_HEADER_ID = gmsAWARDHEABE0.ID
AND gmsAWARDHEABE0.ID = gmsAWARDREFE0.AWARD_ID
AND gmsAWARDREFE0.REFERENCE_TYPE = gmsREFE0.REFERENCE_ID
AND SYSDATE BETWEEN gmsREFE0.START_DATE_ACTIVE AND NVL(gmsREFE0.END_DATE_ACTIVE,TO_DATE('4712-12-31','YYYY-MM-DD'))
