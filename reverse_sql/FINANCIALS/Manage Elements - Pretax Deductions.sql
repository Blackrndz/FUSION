 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Elements%20-%20Pretax%20Deductions.sql $:
 * $Id: Manage Elements - Pretax Deductions.sql 78239 2022-04-07 15:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
,DECODE(elementsE0.ITERATIVE_FLAG,'Y','Yes','No') RES_IS_THIS_ELEMENT_SUBJECT__1	-- Is this element subject to iterative processing?
...
,(CASE
	...
	END) RES_WHAT_IS_THE_CFDI_CODE_WH_2 -- What is the CFDI Code when this element result is negative?
,(CASE
	WHEN legislativeDataGrpsE0.LEGISLATION_CODE = 'MX' THEN
		NULL
...
AND prClassesE0.CLASSIFICATION_NAME = 'Pretax Deductions'
...
/*AND (elementsE0.ELEMENT_NAME NOT LIKE '%Result'
	AND elementsE0.ELEMENT_NAME NOT LIKE '%Calculator'
	AND elementsE0.ELEMENT_NAME NOT LIKE '%Results')*/
