...
,ValueSetValuePEO.LAST_UPDATED_BY  as RSC_LAST_UPDATED_BY
,ValueSetValuePEO.LAST_UPDATE_DATE  AS RSC_LAST_UPDATE_DATE
...
FROM FND_VS_VALUE_SETS ValueSetPEO, 
    FND_VS_VALUES_VL ValueSetValuePEO
where (--ValueSetValuePEO.ATTRIBUTE_CATEGORY IS NOT NULL OR
...
ValueSetValuePEO.ATTRIBUTE50 IS NOT NULL 
 ...
 AND ValueSetValuePEO.VALUE_SET_ID = ValueSetPEO.VALUE_SET_ID
