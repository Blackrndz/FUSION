...
,DECODE(TO_CHAR(perGRADELADEO.EFFECTIVE_END_DATE,'DD-MM-YYYY'),'31-12-4712',NULL,TO_CHAR(perGRADELADEO.EFFECTIVE_END_DATE,'DD-Mon-YYYY')) RES_EFFECTIVE_END_DATE
...
,(SELECT MEANING 
	...
	AND LOOKUP_CODE = perGRADELADEO.GRADE_TYPE
	) RES_GRADE_TYPE
...
ORDER BY perGRADELADEO.NAME
,perGRADELADEO.EFFECTIVE_START_DATE