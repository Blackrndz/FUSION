...
,PayRollSecurityProfileEO.Name RES_PAYROLL_SECURITY_PROFILE
,PayRollSecurityProfileEO.Name RES_NAME_BASIC_DETAILS
,PayRollSecurityProfileEO.PayFlowFlag RES_ENABLED
,PayRollSecurityProfileEO.PayFlowVA RES_VIEW_ALL
...
,(SELECT PayRoll.Name
	,DECODE(PayRoll.ENABLED_FLAG, 'Y', 'Yes', 'No') PayFlowFlag
	,DECODE(PayRoll.VIEW_ALL, 'Y', 'Yes', 'No') PayFlowVA
	,PayRoll.CREATED_BY
	,PayRoll.CREATION_DATE
	,PayRoll.LAST_UPDATED_BY
	,PayRoll.LAST_UPDATE_DATE
	,PayRoll.BUSINESS_GROUP_ID
