...
* $Id: Manage Locations - France Details.sql 80146 2023-02-10 10:05:41Z tanawat.wongjan $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
,(SELECT MEANING
	FROM HR_LOOKUPS
	WHERE LOOKUP_TYPE = 'HRX_FR_LOCATION_TYPE'
	AND ENABLED_FLAG  = 'Y'
	AND LOOKUP_CODE   = FranceS.lle_information1
	) RES_LOCATION_TYPE
, FranceS.lle_information2 RES_REPORTING_CODE
, FranceS.lle_information3 RES_ORGANIZATION_SIRET
, FranceS.lle_information4 RES_ISSUER_NUMBER
...
,(SELECT AAA.location_id
	...
	AND AAA.lle_information_category = 'HRX_FR_EXT_REPORTING_INFO'
...
WHERE((HEAD.location_id = FranceS.location_id(+))
AND((HEAD.EFFECTIVE_START_DATE BETWEEN FranceS.EFFECTIVE_START_DATE(+) AND FranceS.EFFECTIVE_END_DATE(+))
AND(HEAD.EFFECTIVE_END_DATE BETWEEN FranceS.EFFECTIVE_START_DATE(+) AND FranceS.EFFECTIVE_END_DATE(+))))
