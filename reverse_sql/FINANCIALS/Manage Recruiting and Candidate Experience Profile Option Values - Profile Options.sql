 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Recruiting%20and%20Candidate%20Experience%20Profile%20Option%20Values%20-%20Profile%20Options.sql $:
 * $Id: Manage Recruiting and Candidate Experience Profile Option Values - Profile Options.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
,(SELECT APPLICATION_NAME
	...
	WHERE APPLICATION_ID = ProfileOptionEO.APPLICATION_ID
	) RES_APPLICA_MODULE
