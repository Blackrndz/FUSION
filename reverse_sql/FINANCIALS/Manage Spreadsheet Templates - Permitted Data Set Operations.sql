...
,DECODE(hrcSDLROLEO.CREATE_DATA_SET,'Y','Yes','No') RES_CREATE
,DECODE(hrcSDLROLEO.SAVE_DATA_SET,'Y','Yes','No') RES_SAVE
,DECODE(hrcSDLROLEO.UPLOAD_DATA_SET,'Y','Yes','No') RES_UPLOAD
,DECODE(hrcSDLROLEO.VIEW_ALL_DATA_SETS,'Y','Yes','No') RES_VIEW_ALL
