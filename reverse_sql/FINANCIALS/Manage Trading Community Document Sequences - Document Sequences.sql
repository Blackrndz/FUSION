 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Trading%20Community%20Document%20Sequences%20-%20Document%20Sequences.sql $:
 * $Id: Manage Trading Community Document Sequences - Document Sequences.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
FROM (SELECT distinct DocumentSequencesEO.DOC_SEQUENCE_ID
