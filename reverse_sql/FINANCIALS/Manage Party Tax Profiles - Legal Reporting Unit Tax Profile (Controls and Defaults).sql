...
,(SELECT MEANING
	...
	AND LOOKUP_CODE   = PartyTaxProfileEO.ROUNDING_LEVEL_CODE
	) RES_ROUNDING_LEVEL
,(SELECT MEANING
	FROM FND_LOOKUPS
	WHERE LOOKUP_TYPE = 'ZX_ROUNDING_RULE'
	AND LOOKUP_CODE   = PartyTaxProfileEO.ROUNDING_RULE_CODE
	) RES_ROUNDING_RULE
,DECODE(PartyTaxProfileEO.INCLUSIVE_TAX_FLAG,'Y','Yes','N','No') RES_SET_INVOICE_VALUES_AS_TAX_
,PartyTaxProfileEO.TAX_CLASSIFICATION_CODE RES_TAX_CLASSIFICATION_CODE
...
AND (PartyTaxProfileEO.ROUNDING_LEVEL_CODE IS NOT NULL
