 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Specify%20Ledger%20Options%20(Primary%20Ledger)%20-%20Specify%20Ledger%20Options.sql $:
 * $Id: Specify Ledger Options (Primary Ledger) - Specify Ledger Options.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
, DECODE(GL.STRICT_PERIOD_CLOSE_FLAG,'Y','Yes','No')  RES_PREVENT_GENERAL_LEDGER_PER
...
, DECODE(gl.INCOME_STMT_ADB_STATUS_CODE,'ENABLED','Yes','No') RES_INCLUDE_INCOME_STATEMENT_A
, gl.NET_INCOME_CODE_COMBINATION_ID RES_NET_INCOME_ACCOUNT
, TransactionCalendarPEO.NAME RES_TRANSACTION_CALENDAR
, DECODE(GL.SEQUENCING_MODE_CODE,'L','Ledger','LE','Legal entity','N','No sequencing') RES_SEQUENCING_BY
, DECODE(gl.AP_DOC_SEQUENCING_OPTION_FLAG,'Y','Yes','No') RES_ENFORCE_DOCUMENT_SEQUENCIN
, DECODE(gl.AR_DOC_SEQUENCING_OPTION_FLAG,'Y','Yes','No') RES_ENFORCE_DOCUMENT_SEQUENC_0
, DECODE(gl.ENF_SEQ_DATE_CORRELATION_CODE,'Y','Yes','P','Yes','No') RES_ENFORCE_CHRONOLOGICAL_ORDE
, DECODE(gl.ENF_SEQ_DATE_CORRELATION_CODE,'Y','Yes','R','Yes','No') RES_ENFORCE_CHRONOLOGICAL_OR_1
