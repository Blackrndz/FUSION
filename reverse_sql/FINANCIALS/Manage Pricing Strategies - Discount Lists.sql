...
,(SELECT NAME
	FROM QP_DISCOUNT_LISTS_TL
	WHERE DISCOUNT_LIST_ID = QpStrategyDetailE0.DETAIL_ENTITY_ID
	AND LANGUAGE        = USERENV('LANG')
	) RES_DISCOUNT_LIST_NAME
...
AND QpStrategyDetailE0.DETAIL_ENTITY_TYPE_CODE = 'DISCOUNT_LIST'
