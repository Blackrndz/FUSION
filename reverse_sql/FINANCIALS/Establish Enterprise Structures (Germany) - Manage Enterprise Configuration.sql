 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Establish%20Enterprise%20Structures%20(Germany)%20-%20Manage%20Enterprise%20Configuration.sql $:
 * $Id: Establish Enterprise Structures (Germany) - Manage Enterprise Configuration.sql 79797 2022-12-09 04:48:48Z tanawat.wongjan $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
  ...
  HrwLocationsEO.REGION1 RES_COUNTY,
  HrwLocationsEO.REGION2 RES_STATE
...
AND LegalEntityEO.COUNTRY_CODE = 'DE'
