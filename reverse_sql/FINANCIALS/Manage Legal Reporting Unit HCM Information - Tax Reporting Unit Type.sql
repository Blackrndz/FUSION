 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Legal%20Reporting%20Unit%20HCM%20Information%20-%20Tax%20Reporting%20Unit%20Type.sql $:
 * $Id: Manage Legal Reporting Unit HCM Information - Tax Reporting Unit Type.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
,(SELECT MEANING
    ...
    AND LOOKUP_TYPE = 'PER_TRU_TYPE'
    AND LOOKUP_CODE = taxRptsE0.ORG_INFORMATION1
    ) RES_TAX_REPORTING_UNIT_TYPE
...
,(SELECT ORGANIZATION_ID
    ...
    WHERE ORG_INFORMATION_CONTEXT = 'PER_TRU_TYPE'
    ) taxRptsE0
