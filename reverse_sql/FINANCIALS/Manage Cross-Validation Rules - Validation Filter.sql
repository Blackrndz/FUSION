 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Cross-Validation%20Rules%20-%20Validation%20Filter.sql $:
 * $Id: Manage Cross-Validation Rules - Validation Filter.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
,(CASE
	WHEN EXTRACTVALUE(value(X),'/filterCriteriaItem/operator') != 'CUSTOM' THEN
		(SELECT decode(MEANING,'Equals to','Equals','Not equals to','Does not equal',MEANING)
		FROM GL_LOOKUPS
	...
	END) RES_CONDITION
,EXTRACTVALUE(value(X),'/filterCriteriaItem/value[1]') RES_VALUE1
,EXTRACTVALUE(value(X),'/filterCriteriaItem/value[2]') RES_VALUE2
...
,TABLE(XMLSEQUENCE(extract(KFFCrossValRuleEO.VALIDATION_FILTER,
