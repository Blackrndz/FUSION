 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Establish%20Enterprise%20Structures%20(Belgium)%20-%20Manage%20Enterprise%20Configuration.sql $:
 * $Id: Establish Enterprise Structures (Belgium) - Manage Enterprise Configuration.sql 79803 2022-12-09 08:39:48Z tanawat.wongjan $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
  ...
  HrwLocationsEO.ADDRESS_LINE2 RES_HOUSE_NUMBER,
  HrwLocationsEO.ADDRESS_LINE3 RES_HOUSE_NUMBER_ADDITION,
...
AND LegalEntityEO.COUNTRY_CODE = 'BE'
