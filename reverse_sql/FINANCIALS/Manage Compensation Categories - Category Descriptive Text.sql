...
-- REPLACE_HTML_KEYWORD = RES_TEXT_AREA

SELECT compCatsE0.NAME RES_CATEGORY_NAME
,DECODE(compCatsE0.HIDE_DESC_TXT_FLAG,'Y','Yes','No') RES_DO_NOT_DISPLAY_DESCRIPTIVE
,REPLACE(REPLACE(REPLACE(compCatsE0.DESC_TXT,'&','#AMP#'),'<','#OPENTAG#'),'>','#CLOSETAG#') RES_TEXT_AREA
