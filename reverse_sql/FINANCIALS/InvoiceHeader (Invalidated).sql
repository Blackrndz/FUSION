...
,SupplierDetailsE0.PARTY_NAME RES_SUPPLIER_NAME
,SuppliersE0.SEGMENT1 RES_SUPPLIER_NUMBER
,SupplierSitesE0.VENDOR_SITE_CODE RES_SUPPLIER_SITE
,InvoicesE0.INVOICE_CURRENCY_CODE RES_INVOICE_CURRENCY
,InvoicesE0.PAYMENT_CURRENCY_CODE RES_PAYMENT_CURRENCY
,REPLACE(REPLACE(InvoicesE0.DESCRIPTION,chr(13),' '),chr(10),' ') RES_DESCRIPTION
,'' RES_IMPORT_SET
...
,POZ_SUPPLIER_SITES_ALL_M SupplierSitesE0
,HZ_PARTIES SupplierDetailsE0
,(SELECT * 
	FROM PER_PERSON_NAMES_F
	WHERE SYSDATE BETWEEN EFFECTIVE_START_DATE AND EFFECTIVE_END_DATE
	) RequesterE0
WHERE InvoicesE0.VENDOR_ID = SuppliersE0.VENDOR_ID
AND InvoicesE0.VENDOR_SITE_ID = SupplierSitesE0.VENDOR_SITE_ID
AND SuppliersE0.PARTY_ID = SupplierDetailsE0.PARTY_ID
AND InvoicesE0.REQUEST_ID =  RequesterE0.PERSON_ID(+)
