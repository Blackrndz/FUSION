...
(SELECT DISTINCT prsE0.PAYROLL_NAME RES_PAYROLL
...
AND costsE0.COST_ALLOCATION_RECORD_ID = payCostalloaccE0.COST_ALLOCATION_RECORD_ID
AND payCostalloaccE0.ID_FLEX_NUM = fndIDFLEXE0.ID_FLEX_NUM
AND fndIDFLEXE0.APPLICATION_COLUMN_NAME = payCostalloaccE0.SEG_ID
ORDER BY prsE0.PAYROLL_NAME,fndIDFLEXE0.SEGMENT_NUM)
