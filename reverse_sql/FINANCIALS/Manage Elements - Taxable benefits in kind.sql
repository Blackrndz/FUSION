 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Elements%20-%20Taxable%20benefits%20in%20kind.sql $:
 * $Id: Manage Elements - Taxable benefits in kind.sql 78239 2022-04-07 15:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
,'' RES_SHOULD_THIS_ELEMENT_BE_I_1	-- Should this element be included in the hours calculation of the FLSA overtime base rate?	
,'' RES_RATE_NAME
...
AND prClassesE0.BASE_CLASSIFICATION_NAME = 'ORA_HRX_GB_TAXABLE_BENEFITS'
...
/*AND (elementsE0.ELEMENT_NAME NOT LIKE '%Retroactive'
	AND elementsE0.ELEMENT_NAME NOT LIKE '%Calculation'
	AND elementsE0.ELEMENT_NAME NOT LIKE '%Result'
	AND elementsE0.ELEMENT_NAME NOT LIKE '%Retro')*/
