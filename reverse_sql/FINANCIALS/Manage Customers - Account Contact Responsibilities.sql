...
,DECODE(HzRoleResponsibilityE0.PRIMARY_FLAG,'Y','Yes','N','No') RES_PRIMARY_RESPONSIBILITY
,(SELECT MEANING
	FROM FND_LOOKUPS
	WHERE LOOKUP_TYPE = 'SITE_USE_CODE'
	AND LOOKUP_CODE = HzRoleResponsibilityE0.RESPONSIBILITY_TYPE
...
,HzRoleResponsibilityE0.RESPONSIBILITY_TYPE