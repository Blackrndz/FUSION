...
* $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Data%20Role%20and%20Security%20Profiles%20-%20Data%20Roles.sql $:
* $Id: Manage Data Role and Security Profiles - Data Roles.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
,description RES_ROLE_DESCRIPTION
,DECODE(delegation_allowed,'Y','Yes','No') RES_DELEGATION_ALLOWED
...
FROM
	...
	UNION
	SELECT gen.data_role_display_name
...
ORDER BY role_name,RES_DATA_ROLE_CODE