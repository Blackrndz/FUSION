...
* $HeadURL: http://svn01.rapidesuite.com:999/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13.19/trunk/core/reverse_sql/FINANCIALS/Manage%20Departments%20-%20Manage%20Departments%20-%20DFF.sql $:
* $Id: Manage Departments - Manage Departments - DFF.sql 71621 2019-03-15 02:40:15Z pisan.jariyasettachok $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
/*,(
	CASE
		WHEN EXISTS
			...
			WHERE OrgUnitClassificationDEO2.CLASSIFICATION_CODE != 'BEN TPA'
			...
			AND EXISTS
				...
				WHERE OrgUnitClassificationDEO3.CLASSIFICATION_CODE = 'BEN TPA'
