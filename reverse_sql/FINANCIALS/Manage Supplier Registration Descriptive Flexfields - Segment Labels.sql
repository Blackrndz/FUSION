 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Supplier%20Registration%20Descriptive%20Flexfields%20-%20Segment%20Labels.sql $:
 * $Id: Manage Supplier Registration Descriptive Flexfields - Segment Labels.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
WHERE SegmentLabel.APPLICATION_ID = 10044
AND SegmentLabel.DESCRIPTIVE_FLEXFIELD_CODE = 'POZ_SUPPLIERS'
