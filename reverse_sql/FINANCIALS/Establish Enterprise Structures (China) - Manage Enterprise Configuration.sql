 ...
 * ************************************************************************** */
  ...
  HrwLocationsEO.TOWN_OR_CITY AS RES_PREFECTURE,
  HrwLocationsEO.ADDL_ADDRESS_ATTRIBUTE2 AS RES_COUNTY_OR_DISTRICT,
  HrwLocationsEO.ADDRESS_LINE1 AS RES_STREET_ADDRESS,
  HrwLocationsEO.ADDRESS_LINE2 AS RES_ADDITIONAL_ADDRESS_LINE
...
AND LegalEntityEO.COUNTRY_CODE = 'CN'
