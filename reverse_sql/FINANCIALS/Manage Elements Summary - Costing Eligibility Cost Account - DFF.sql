...
WITH KFF_STRUTURE AS (SELECT ID_FLEX_NUM
	...
	AND EXISTS (SELECT 1
		...
		AND kfLbl.SEGMENT_LABEL_CODE = 'ELEMENT'
...
AND NVL(payElementlinkE0.EFFECTIVE_END_DATE,TO_DATE('4712-12-31','YYYY-MM-DD')) BETWEEN payCostalloE0.EFFECTIVE_START_DATE AND NVL(payCostalloE0.EFFECTIVE_END_DATE,TO_DATE('4712-12-31','YYYY-MM-DD'))
AND payCostalloE0.COST_ALLOCATION_RECORD_ID = payCostalloaccE0.COST_ALLOCATION_RECORD_ID
AND payCostalloE0.SOURCE_TYPE = 'EL'
AND payCostalloaccE0.SOURCE_SUB_TYPE = 'COST'
