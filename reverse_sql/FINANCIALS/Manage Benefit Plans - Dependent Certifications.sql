 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Benefit%20Plans%20-%20Dependent%20Certifications.sql $:
 * $Id: Manage Benefit Plans - Dependent Certifications.sql 78895 2022-06-29 08:34:19Z tanawat.wongjan $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
,TO_CHAR(dpnActionItemsE0.EFFECTIVE_START_DATE,'DD-Mon-YYYY') RES_DEPENDENT_CERTIFICATIONS_E
,DECODE(TO_CHAR(dpnActionItemsE0.EFFECTIVE_END_DATE,'DD-Mon-YYYY'),'31-12-4712',NULL,TO_CHAR(dpnActionItemsE0.EFFECTIVE_END_DATE,'DD-Mon-YYYY')) RES_DEPENDENT_CERTIFICATIONS_0
,(SELECT MEANING
    FROM FND_LOOKUP_VALUES
    WHERE LANGUAGE = USERENV('LANG')
