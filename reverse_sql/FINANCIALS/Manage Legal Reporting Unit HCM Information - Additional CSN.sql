 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Legal%20Reporting%20Unit%20HCM%20Information%20-%20Additional%20CSN.sql $:
 * $Id: Manage Legal Reporting Unit HCM Information - Additional CSN.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
,csnE0.ORG_INFORMATION1 RES_CPF_SUBMISSION_NUMBER
,csnE0.LAST_UPDATED_BY RSC_LAST_UPDATED_BY
,csnE0.LAST_UPDATE_DATE RSC_LAST_UPDATE_DATE
,csnE0.CREATED_BY RSC_CREATED_BY
,csnE0.CREATION_DATE RSC_CREATION_DATE
,NULL RSC_LEDGER_ID
...
,(SELECT ORGANIZATION_ID
    ...
    WHERE ORG_INFORMATION_CONTEXT = 'HRX_SG_CSN_NUMBERS'
    ) csnE0
WHERE orgsE0.ORGANIZATION_ID = csnE0.ORGANIZATION_ID
AND orgsE0.EFFECTIVE_START_DATE BETWEEN csnE0.EFFECTIVE_START_DATE AND csnE0.EFFECTIVE_END_DATE
