 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Establish%20Enterprise%20Structures%20(United%20States)%20-%20Manage%20Enterprise%20Configuration.sql $:
 * $Id: Establish Enterprise Structures (United States) - Manage Enterprise Configuration.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
  ...
  HrwLocationsEO.REGION2 AS RES_STATE,
  /*(CASE
	WHEN HrwLocationsEO.REGION1 IS NULL THEN
		HrwLocationsEO.REGION2
	ELSE HrwLocationsEO.REGION1	END
	)AS RES_STATE,*/
  HrwLocationsEO.REGION1 AS RES_COUNTY,
...
AND LegalEntityEO.COUNTRY_CODE = 'US'
