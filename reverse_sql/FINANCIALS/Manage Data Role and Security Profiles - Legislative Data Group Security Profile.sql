...
,LDGSecurityProfileEO.LDGFLAG RES_ENABLED
,LDGSecurityProfileEO.LDGVIEWALL RES_VIEW_ALL
...
,(SELECT LDGE0.Name
	,DECODE(LDGE0.ENABLED_FLAG, 'Y', 'Yes', 'No') LDGFLAG
	,DECODE(LDGE0.VIEW_ALL, 'Y', 'Yes', 'No') LDGVIEWALL
	,LDGE0.CREATED_BY
	,LDGE0.CREATION_DATE
