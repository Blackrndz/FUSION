...
* $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Document%20Descriptive%20Flexfields%20-%20Contexts.sql $:
* $Id: Manage Document Descriptive Flexfields - Contexts.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
AND DescriptiveFlexfieldEO.DESCRIPTIVE_FLEXFIELD_CODE NOT IN ('PER_DOC_OF_RECORD_LEG_DDF')
AND(DescriptiveFlexfieldEO.module_id     IN
	...
	AND t.module_key         = ('HcmDocsOfRecordCore')
	))
