...
* $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Fixed%20Assets%20Key%20Flexfields%20-%20Manage%20Key%20Flexfield%20Segment.sql $:
* $Id: Manage Fixed Assets Key Flexfields - Manage Key Flexfield Segment.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
WHERE KeyFlexfieldSegmentEO.STRUCTURE_ID IN
	(SELECT STRUCTURE_ID
	FROM FND_KF_STRUCTURES_VL
	WHERE APPLICATION_ID = 140
	)
ORDER BY RES_KEY_FLEXFIELD_CODE,KeyFlexfieldSegmentEO.SEQUENCE_NUMBER