...
,ROLE_COMMON_NAME RES_DATA_ROLE_CODE
...
,DocTypeProfileEO.DocFlag RES_ENABLED
,DocTypeProfileEO.InEx RES_INCLUDE_OR_EXCLUDE_DOCUMEN
...
,(SELECT DocType.Name
	,DECODE(DocType.ENABLED_FLAG, 'Y', 'Yes', 'No') DocFlag
	,DECODE(DocType.INCLUDE_EXCLUDE_FLAG, 'E', 'Exclude', 'I', 'Include') InEx
	,DocType.CREATED_BY
	,DocType.CREATION_DATE
	,DocType.LAST_UPDATED_BY
	,DocType.LAST_UPDATE_DATE
	,DocType.BUSINESS_GROUP_ID
