...
* $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Project%20Templates%20-%20Forecasts%20Export%20Options.sql $:
* $Id: Manage Project Templates - Forecasts Export Options.sql 78693 2022-06-07 10:22:14Z tanawat.wongjan $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
,DECODE(planningOptionsE0.EXL_DISP_COMMITTMENTS,'Y','Yes','No') RES_DISPLAY_COMMITMENTS
...
AND (tmpMEASEO.NAME NOT LIKE '%TOTAL'
AND tmpMEASEO.NAME != 'TOT_QTY')
