...
,CodeMapValueEO.INPUT_VALUE RES_INPUT_VALUE
,CodeMapValueEO.OUTPUT_VALUE RES_OUTPUT_VALUE
,CodeMapValueEO.LAST_UPDATED_BY RSC_LAST_UPDATED_BY
,CodeMapValueEO.LAST_UPDATE_DATE RSC_LAST_UPDATE_DATE
,CodeMapValueEO.CREATED_BY RSC_CREATED_BY
,CodeMapValueEO.CREATION_DATE RSC_CREATION_DATE
,NULL RSC_LEDGER_ID
...
,IBY_CODE_MAP_FLD_VALUES CodeMapValueEO
WHERE CodeMapFieldEO.CODE_MAP_GROUP_CODE = CodeMapGroupEO.CODE_MAP_GROUP_CODE
AND CodeMapFieldEO.CODE_MAP_FIELD_ID     = CodeMapValueEO.CODE_MAP_FIELD_ID
ORDER BY RES_NAME
,RES_FIELD
,RES_INPUT_VALUE