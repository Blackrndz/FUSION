 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Profile%20Rating%20Models%20-%20Distributions.sql $:
 * $Id: Manage Profile Rating Models - Distributions.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
SELECT hrtRatingModelEO.RATING_MODEL_CODE RES_CODE
 ...
 ,hrtRatingLevelEO.RATING_DESCRIPTION RES_DISTRIBUTIONS_NAME
 ,hrtRatingLevelEO.MIN_RATING_DISTRIBUTION RES_MINIMUM_DISTRIBUTION
 ,hrtRatingLevelEO.MAX_RATING_DISTRIBUTION RES_MAXIMUM_DISTRIBUTION
