 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Elements%20-%20Perquisites.sql $:
 * $Id: Manage Elements - Perquisites.sql 78239 2022-04-07 15:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
,(CASE
	...
	END) RES_WORK_UNITS_CONVERSION_RULE
,(CASE
	WHEN EXISTS (SELECT 1 
			FROM PAY_DIR_CARD_COMP_DEFS_F cardComp
			,PAY_DIR_CARD_DEFINITIONS cardDef
			...
			AND elementsFE0.EFFECTIVE_END_DATE BETWEEN cardComp.EFFECTIVE_START_DATE AND cardComp.EFFECTIVE_END_DATE) THEN 
		'No'
	END) RES_DOES_THIS_ELEMENT_HAVE_A_D -- Does this element have a default rate definition?
,'' RES_RATE_NAME
...
AND prClassesE0.CLASSIFICATION_NAME = 'Perquisites'
