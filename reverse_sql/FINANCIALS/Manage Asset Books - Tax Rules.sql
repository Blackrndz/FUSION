 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Asset%20Books%20-%20Tax%20Rules.sql $:
 * $Id: Manage Asset Books - Tax Rules.sql 78229 2022-04-07 07:37:05Z pisan.jariyasettachok $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
,DECODE(QRSLT.ALLOW_CIP_ASSETS_FLAG,'YES','Yes','No') RES_ALLOW_CIP_ASSETS
,DECODE(QRSLT.ALLOW_COST_CEILING,'YES','Yes','No') RES_ALLOW_COST_CEILINGS
,DECODE(QRSLT.ALLOW_DEPRN_EXP_CEILING,'YES','Yes','No') RES_ALLOW_EXPENSE_CEILINGS
,DECODE(QRSLT.COPY_SALVAGE_VALUE_FLAG,'YES','Yes','No') RES_COPY_SALVAGE_VALUE
,DECODE(QRSLT.COPY_GROUP_ADDITION_FLAG,'Y','Yes','No') RES_COPY_GROUP_ASSET_ADDITIONS
,DECODE(QRSLT.COPY_GROUP_ASSIGNMENT_FLAG,'Y','Yes','No') RES_COPY_MEMBER_ASSET_ASSIGNME
,DECODE(QRSLT.COPY_GROUP_CHANGE_FLAG,'Y','Yes','No') RES_COPY_GROUP_ASSET_CHANGES
,DECODE(QRSLT.ALLOW_MASS_COPY,'YES','Yes','No') RES_ALLOW_MASS_COPY
,DECODE(QRSLT.COPY_ADDITIONS_FLAG,'YES','Yes','No') RES_COPY_ADDITIONS
,DECODE(QRSLT.COPY_ADJUSTMENTS_FLAG,'YES','Yes','No') RES_COPY_ADJUSTMENTS
,DECODE(QRSLT.COPY_ALL_COST_ADJUSTMENTS_FLAG,'Y','Yes','No') RES_COPY_CHANGES_WHEN_COST_IS_
,DECODE(QRSLT.COPY_RETIREMENTS_FLAG,'YES','Yes','No') RES_COPY_RETIREMENTS
,DECODE(QRSLT.COPY_AMORT_ADAJ_EXP_FLAG,'Y','Yes','No') RES_COPY_AMORTIZED_ADDITIONS_A
,DECODE(QRSLT.COPY_TRANSFERS_FLAG,'Y','Yes','No') RES_COPY_TRANSFERS
,DECODE(QRSLT.COPY_LEASE_ASSETS_FLAG,'Y','Yes','No') RES_COPY_LEASED_ASSETS
,DECODE(QRSLT.TRACK_SOURCE_LINES_IN_TAX_FLAG,'Y','Yes','No') RES_ALLOW_SOURCE_LINES
,QRSLT.LAST_PURGE_PERIOD_COUNTER  RES_LAST_PERIOD_COPIED
...
FROM
	(SELECT BookControlEO.BOOK_CONTROL_ID
	...
	,BookControlEO.COPY_GROUP_CHANGE_FLAG
	...
	,BookControlEO.COPY_LEASE_ASSETS_FLAG
	,BookControlEO.COPY_TRANSFERS_FLAG
	,BookControlEO.TRACK_SOURCE_LINES_IN_TAX_FLAG
	...
	AND BookControlEO.BOOK_CLASS = 'TAX'
	AND BOOKCONTROLEO.SET_OF_BOOKS_ID = GLLEDGERS.LEDGER_ID(+)
	) QRSLT
