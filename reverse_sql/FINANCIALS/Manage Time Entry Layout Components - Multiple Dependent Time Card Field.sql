...
,NVL(dependentTmMsE0.DET_INS_DISPLAY_NAME,dependentTmE0.DISPLAY_NAME) RES_DEPENDENT_TIME_ATTRIBUTE
,(CASE
	WHEN dependentTmMsE0.DET_INS_DISPLAY_NAME IS NOT NULL THEN
		'Detailed'
	ELSE
		DECODE(dependentTmE0.CLASS,'DETAIL_INSTANCE','Detailed','GLOBAL_DETAIL','General')
	END) RES_LEVEL
,(CASE
	WHEN dependentTmMsE0.DET_INS_DISPLAY_NAME IS NOT NULL THEN
		dependentTmMsE0.MASTER_INSTANCE_IDENTIFIER
	ELSE
		(CASE
...
,(SELECT DISTINCT DET_INS_DISPLAY_NAME 
	--DISPLAY_NAME FROM HWM_TM_ATRB_FLDS_VL
...
,DECODE(dependentsE0.TCLAYFLD_ATTRIBUTE_CHAR22,'Y','Yes','N','No') RES_REQUIRED_ON_THE_TIME_CARD
...
,HWM_TM_ATRB_FLD_MSTR_REF_VL dependentTmMsE0
...
AND dependentsE0.TCLAYFLD_ATTRIBUTE_NUMBER1 = dependentTmMsE0.TM_ATRB_FLD_ID(+)
AND dependentsE0.TCLAYFLD_ATTRIBUTE_NUMBER20 = dependentTmMsE0.TM_ATRB_FLD_MSTR_REF_ID(+)
