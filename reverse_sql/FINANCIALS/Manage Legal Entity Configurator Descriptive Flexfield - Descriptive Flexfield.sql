...
* $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Legal%20Entity%20Configurator%20Descriptive%20Flexfield%20-%20Descriptive%20Flexfield.sql $:
* $Id: Manage Legal Entity Configurator Descriptive Flexfield - Descriptive Flexfield.sql 78284 2022-04-13 06:03:20Z pisan.jariyasettachok $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
,DECODE(ContextSegment.DISPLAY_TYPE,'HIDDEN','Hidden','List of Values') AS RES_DISPLAY_TYPE
...
AND DescriptiveFlexfieldEO.APPLICATION_ID             = 204
