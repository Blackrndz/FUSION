...
,(SELECT JOB_FAMILY_NAME FROM PER_JOB_FAMILY_F_VL WHERE JOB_FAMILY_ID = benELIGGENCRITEO.CRIT_CHAR1
	AND SYSDATE BETWEEN EFFECTIVE_START_DATE AND NVL(EFFECTIVE_END_DATE,TO_DATE('4712-12-31','YYYY-MM-DD'))) RES_JOB_FAMILY
...
AND benELIGGENCRITEO.ELIG_CRITERIA_CODE = 'JFM'
