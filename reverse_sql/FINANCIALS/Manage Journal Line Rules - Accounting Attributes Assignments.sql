...
,AttributesE0.NAME RES_ACCOUNTING_ATTRIBUTE
,(SELECT NAME 
	FROM XLA_SOURCES_TL
	WHERE APPLICATION_ID = AccAttributesE0.SOURCE_APPLICATION_ID
	AND SOURCE_TYPE_CODE = AccAttributesE0.SOURCE_TYPE_CODE
	AND SOURCE_CODE = AccAttributesE0.SOURCE_CODE
	AND LANGUAGE = USERENV('LANG')
	) RES_SOURCE
,AccAttributesE0.LAST_UPDATED_BY RSC_LAST_UPDATED_BY
,AccAttributesE0.LAST_UPDATE_DATE RSC_LAST_UPDATE_DATE
,AccAttributesE0.CREATED_BY RSC_CREATED_BY
,AccAttributesE0.CREATION_DATE RSC_CREATION_DATE
,NULL RSC_LEDGER_ID
