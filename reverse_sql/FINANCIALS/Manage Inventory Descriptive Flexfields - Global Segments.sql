...
* $HeadURL: http://svn01.rapidesuite.com:999/svn/a/dev/rapidesuite/controldata/FUSION_11.1.9/trunk/core/reverse_sql/FINANCIALS/Manage%20Receivables%20Descriptive%20Flexfields%20-%20Global%20Segments.sql $:
* $Id: Manage Receivables Descriptive Flexfields - Global Segments.sql 61299 2017-03-07 03:46:41Z pisan.jariyasettachok $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
,DECODE(DescriptiveFlexfieldEO.BI_ENABLED_FLAG,'Y',
	...
	AND APPLICATION_ID = GlobalSegment.APPLICATION_ID
