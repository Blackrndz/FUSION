...
* $Id: Manage Locations - Netherlands Details.sql 80146 2023-02-10 10:05:41Z tanawat.wongjan $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
, DECODE(NVL(AddressFormatE0.ADDRESS_STYLE_CODE,'POSTAL_ADDR'),'SUPP_TAX_AND_RPTNG_ADDR',HEAD.ADDRESS_LINE_2,NULL) RES_HOUSE_OR_BUILDING_NUMBER
, DECODE(NVL(AddressFormatE0.ADDRESS_STYLE_CODE,'POSTAL_ADDR'),'SUPP_TAX_AND_RPTNG_ADDR',HEAD.ADDRESS_LINE_3,NULL) RES_HOUSE_OR_BUILDING_NUMBER_A
, HEAD.address_line_4 RES_LOCATION_DESCRIPTION
, DECODE(NVL(AddressFormatE0.ADDRESS_STYLE_CODE,'POSTAL_ADDR'),'SUPP_TAX_AND_RPTNG_ADDR',Head.postal_code,NULL) RES_POSTAL_CODE
, DECODE(NVL(AddressFormatE0.ADDRESS_STYLE_CODE,'POSTAL_ADDR'),'POSTAL_ADDR',Head.postal_code,NULL) RES_POST_CODE
