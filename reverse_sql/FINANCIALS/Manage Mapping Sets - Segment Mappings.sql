 ...
 * $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Mapping%20Sets%20-%20Segment%20Mappings.sql $:
 * $Id: Manage Mapping Sets - Segment Mappings.sql 80185 2023-02-16 09:49:42Z tanawat.wongjan $:
 * ****************************************************************************
 * Description:
 * ************************************************************************** */
...
SELECT * FROM (SELECT APPLICATIONPEO.application_name RES_SUBLEDGER_APPLICATION
		...
		WHEN INPUT_SOURCE1.VALUE_SET_ID IS NOT NULL THEN
			(CASE
				WHEN INPUT_SOURCE1.VALIDATION_TYPE = 'TABLE' THEN
					(CASE
						WHEN INPUT_SOURCE1.VALUE_SET_CODE = 'PJC_EXPENDITURE_TYPES_VS' THEN
							(SELECT EXPENDITURE_TYPE_NAME
								FROM PJF_EXP_TYPES_TL
								WHERE LANGUAGE = USERENV('LANG')
								AND TO_CHAR(EXPENDITURE_TYPE_ID) = MAPPINGSETVALUEEO.INPUT_VALUE_CONSTANT1)
						ELSE
							(CASE 
								WHEN MAPPINGSETVALUEEO.INPUT_VALUE_CONSTANT1 IS NOT NULL THEN 
									(CASE 
		...
		WHEN INPUT_SOURCE2.VALUE_SET_ID IS NOT NULL THEN
			(CASE
				WHEN INPUT_SOURCE2.VALIDATION_TYPE = 'TABLE' THEN
					(CASE WHEN MAPPINGSETVALUEEO.INPUT_VALUE_CONSTANT2 IS NOT NULL THEN 
						(CASE 
							WHEN INPUT_SOURCE2.ID_COLUMN_TYPE = 'NUMBER' 
							AND NOT EXISTS (SELECT 1 FROM DUAL 
		...
		WHEN INPUT_SOURCE3.VALUE_SET_ID IS NOT NULL THEN
			(CASE
				WHEN INPUT_SOURCE3.VALIDATION_TYPE = 'TABLE' THEN
					(CASE WHEN MAPPINGSETVALUEEO.INPUT_VALUE_CONSTANT3 IS NOT NULL THEN 
						(CASE 
							WHEN INPUT_SOURCE3.ID_COLUMN_TYPE = 'NUMBER' 
							AND NOT EXISTS (SELECT 1 FROM DUAL 
		...
		WHEN INPUT_SOURCE4.VALUE_SET_ID IS NOT NULL THEN
			(CASE
				WHEN INPUT_SOURCE4.VALIDATION_TYPE = 'TABLE' THEN
					(CASE WHEN MAPPINGSETVALUEEO.INPUT_VALUE_CONSTANT4 IS NOT NULL THEN 
						(CASE 
							WHEN INPUT_SOURCE4.ID_COLUMN_TYPE = 'NUMBER' 
							AND NOT EXISTS (SELECT 1 FROM DUAL 
		...
		WHEN INPUT_SOURCE5.VALUE_SET_ID IS NOT NULL THEN
			(CASE
				WHEN INPUT_SOURCE5.VALIDATION_TYPE = 'TABLE' THEN
					(CASE WHEN MAPPINGSETVALUEEO.INPUT_VALUE_CONSTANT5 IS NOT NULL THEN 
						(CASE 
							WHEN INPUT_SOURCE5.ID_COLUMN_TYPE = 'NUMBER' 
							AND NOT EXISTS (SELECT 1 FROM DUAL 
		...
		WHEN INPUT_SOURCE6.VALUE_SET_ID IS NOT NULL THEN
			(CASE
				WHEN INPUT_SOURCE6.VALIDATION_TYPE = 'TABLE' THEN
					(CASE WHEN MAPPINGSETVALUEEO.INPUT_VALUE_CONSTANT6 IS NOT NULL THEN 
						(CASE 
							WHEN INPUT_SOURCE6.ID_COLUMN_TYPE = 'NUMBER' 
							AND NOT EXISTS (SELECT 1 FROM DUAL 
		...
		WHEN INPUT_SOURCE7.VALUE_SET_ID IS NOT NULL THEN
			(CASE
				WHEN INPUT_SOURCE7.VALIDATION_TYPE = 'TABLE' THEN
					(CASE WHEN MAPPINGSETVALUEEO.INPUT_VALUE_CONSTANT7 IS NOT NULL THEN 
						(CASE 
							WHEN INPUT_SOURCE7.ID_COLUMN_TYPE = 'NUMBER' 
							AND NOT EXISTS (SELECT 1 FROM DUAL 
		...
		WHEN INPUT_SOURCE8.VALUE_SET_ID IS NOT NULL THEN
			(CASE
				WHEN INPUT_SOURCE8.VALIDATION_TYPE = 'TABLE' THEN
					(CASE WHEN MAPPINGSETVALUEEO.INPUT_VALUE_CONSTANT8 IS NOT NULL THEN
						(CASE 
							WHEN INPUT_SOURCE8.ID_COLUMN_TYPE = 'NUMBER' 
							AND NOT EXISTS (SELECT 1 FROM DUAL 
		...
		WHEN INPUT_SOURCE9.VALUE_SET_ID IS NOT NULL THEN
			(CASE
				WHEN INPUT_SOURCE9.VALIDATION_TYPE = 'TABLE' THEN
					(CASE WHEN MAPPINGSETVALUEEO.INPUT_VALUE_CONSTANT9 IS NOT NULL THEN
						(CASE 
							WHEN INPUT_SOURCE9.ID_COLUMN_TYPE = 'NUMBER' 
							AND NOT EXISTS (SELECT 1 FROM DUAL 
		...
		WHEN INPUT_SOURCE10.VALUE_SET_ID IS NOT NULL THEN
			(CASE
				WHEN INPUT_SOURCE10.VALIDATION_TYPE = 'TABLE' THEN
					(CASE WHEN MAPPINGSETVALUEEO.INPUT_VALUE_CONSTANT10 IS NOT NULL THEN
						(CASE 
							WHEN INPUT_SOURCE10.ID_COLUMN_TYPE = 'NUMBER' 
							AND NOT EXISTS (SELECT 1 FROM DUAL 
	...
	AND MAPPINGSETEO.FLEXFIELD_ASSIGN_MODE_CODE = 'S'
...
,NULL RSC_COUNTRY_ID
	...
	,FND_KF_STR_INSTANCES_VL KfStructIns
	,XLA_SUBLEDGERS_TL APPLICATIONPEO
	WHERE MAPPINGSETEO.FLEXFIELD_ASSIGN_MODE_CODE = 'S'
...
WHERE (RES_INPUT_SOURCE1 IS NOT NULL OR 
	RES_INPUT_SOURCE2 IS NOT NULL OR 
	RES_INPUT_SOURCE3 IS NOT NULL OR 
	RES_INPUT_SOURCE4 IS NOT NULL OR 
	RES_INPUT_SOURCE5 IS NOT NULL OR 
	RES_INPUT_SOURCE6 IS NOT NULL OR 
	RES_INPUT_SOURCE7 IS NOT NULL OR 
	RES_INPUT_SOURCE8 IS NOT NULL OR 
	RES_INPUT_SOURCE9 IS NOT NULL OR 
	RES_INPUT_SOURCE10 IS NOT NULL)
