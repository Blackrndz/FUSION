...
,(SELECT meaning
	...
	WHERE lookup_type = (CASE 
							...
							WHEN QRSLT.DETERMINING_FACTOR_CLASS_CODE = 'DOCUMENT' OR QRSLT.DETERMINING_FACTOR_CLASS_CODE = 'TRX_GENERIC_CLASSIFICATION' OR QRSLT.DETERMINING_FACTOR_CLASS_CODE = 'PRODUCT_GENERIC_CLASSIFICATION' THEN
								'ZX_PROD_TRX_CATEG'
...
FROM
	...
	,(CASE
		WHEN ZxConditions.VALUE_LOW IS NOT NULL THEN
			ZxConditions.VALUE_LOW
		WHEN ZxConditions.ALPHANUMERIC_VALUE IS NOT NULL THEN
			ZxConditions.ALPHANUMERIC_VALUE
		WHEN ZxConditions.NUMERIC_VALUE IS NOT NULL THEN
			TO_CHAR(ZxConditions.NUMERIC_VALUE)
		WHEN ZxConditions.DATE_VALUE IS NOT NULL THEN
			TO_CHAR(ZxConditions.DATE_VALUE)
		END) VALUE_LOW
