...
,TO_CHAR(tranConfsE0.START_DATE,'DD-Mon-YYYY') RES_FROM_DATE
,DECODE(TO_CHAR(tranConfsE0.END_DATE,'DD-MM-YYYY'),'31-12-4712',NULL,TO_CHAR(tranConfsE0.END_DATE,'DD-Mon-YYYY')) RES_TO_DATE
