...
AND LookupPEO.LOOKUP_TYPE = 'IBY_VALIDATION_FIELDS'
AND LookupPEO.LOOKUP_CODE = IbyValAssignments.FIELD_NAME_CODE
...
AND IbyValAssignments.FIELD_NAME_CODE IS NOT NULL
