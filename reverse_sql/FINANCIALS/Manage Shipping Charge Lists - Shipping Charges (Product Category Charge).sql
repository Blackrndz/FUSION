...
* $Date: 2017-11-02 $:
* $HeadURL:  $:
* $Id: Manage Shipping Charge Lists - Shipping Charges (Product Category Charge).sql  $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
decode((select LINE_TYPE_CODE
  ...
  decode(XXX.ITEM_LEVEL_CODE,'PRODUCT_CATEGORY','Product category','ITEM','Item')                   RES_ITEM_CATALOG,
  CAT.CATEGORY_NAME                                                                     			RES_CATEGORY,
  CAT.DESCRIPTION                                        					                      	RES_DESCRIPTION,
