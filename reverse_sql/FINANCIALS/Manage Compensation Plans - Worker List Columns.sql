...
,(SELECT MEANING FROM FND_LOOKUP_VALUES WHERE LOOKUP_CODE = cmpCSTME0.REGION_NAME 
			AND LOOKUP_TYPE = 'CMP_BUDGET_EMPLIST_MCOLS' AND LANGUAGE = USERENV('LANG')
			AND SYSDATE BETWEEN START_DATE_ACTIVE AND NVL(END_DATE_ACTIVE,TO_DATE('4712-12-31','YYYY-MM-DD'))) RES_PARENT_COLUMN
,DECODE(cmpCSTME0.ITEM_NAME,'Alert','Alerts', 'AllocationUsed','Allocated', 'EmpBdgtVal','Budget Amount', 'EmpBdgtMaxVal','Budget Amount Maximum Limit', 'EmpBdgtMinVal','Budget Amount Minimum Limit', 'PercentEligSalary'
,'Budget Percentage', 'PerformanceRating','Compensation Performance Rating', 'Currency','Currency', 'EligibilityStatus','Eligibility Status', 'EligibleSalary','Eligible Salary', 'GradeId','Grade', 'JobName','Job'
,'LegalEmployer','Legal Employer', 'Misc1Val','Miscellaneous Rate 1', 'Misc1Val','Miscellaneous Rate 1S', 'Misc2Val','Miscellaneous Rate 2', 'Misc3Val','Miscellaneous Rate 3', 'Misc4Val','Miscellaneous Rate 4', 'Misc5Val'
,'Miscellaneous Rate 5', 'Misc6Val','Miscellaneous Rate 6', 'Name','Name', 'WorkerNumber','Person Number', 'AllocationUnused','Remaining Budget', 'RecVal','Target Allocation', 'RecMxVal','Target Compensation Amount Maximum'
,'RecMnVal','Target Compensation Amount Minimum', 'RecValPct','Target Compensation Percentage', 'RecMxValPct','Target Compensation Percentage Maximum', 'RecMnValPct','Target Compensation Percentage Minimum', 'Uom','Units') RES_COLUMN
...
AND cmpCSTME0.CUSTOM_TYPE = 'BUDGET'
AND cmpCSTME0.REGION_NAME LIKE 'EMP_LIST_TABLE%MCOL'
ORDER BY cmpPLANEO.PLAN_NAME,cmpBUDGETPOOLE0.POOL_NAME,RES_PARENT_COLUMN