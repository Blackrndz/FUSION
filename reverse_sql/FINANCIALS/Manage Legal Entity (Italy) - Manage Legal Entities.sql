...
* $HeadURL: https://svn03.rapid4cloud.com/svn/a/dev/rapidesuite/controldata/FUSION_11.1.13/trunk/core/reverse_sql/FINANCIALS/Manage%20Legal%20Entity%20(Italy)%20-%20Manage%20Legal%20Entities.sql $:
...
,XleRegistrations.REGISTRATION_NUMBER   AS RES_FISCAL_CODE
,(SELECT REGISTRATION_NUMBER
...
AND TerritoryPEO.TERRITORY_CODE         = 'IT'
ORDER BY RES_NAME