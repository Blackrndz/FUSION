...
* $Id: Manage Locations - Mexico Details.sql 80146 2023-02-10 10:05:41Z tanawat.wongjan $:
* ****************************************************************************
* Description:
* ************************************************************************** */
...
, HEAD.ADDL_ADDRESS_ATTRIBUTE3 RES_NEIGHBORHOODCOLONY
, HEAD.ADDL_ADDRESS_ATTRIBUTE2 RES_BOROUGHVILLAGE
...
, DECODE(NVL(AddressFormatE0.ADDRESS_STYLE_CODE,'POSTAL_ADDR'),'SUPP_TAX_AND_RPTNG_ADDR',HEAD.ADDRESS_LINE_2,NULL) RES_NEIGHBORHOOD
, HEAD.region_3 RES_MUNICIPALITY
